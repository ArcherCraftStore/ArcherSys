...
function find_username()
{
	...
	window.open('<?php echo (isset($this->_rootref['UA_FIND_USERNAME'])) ? $this->_rootref['UA_FIND_USERNAME'] : ''; ?>', '_usersearch', 'height=570, resizable=yes, scrollbars=yes, width=760');
	<?php } ?>
	return false;
}
...
{
	<?php if ($this->_rootref['UA_SWATCH']) {  ?>
	window.open('<?php echo (isset($this->_rootref['UA_SWATCH'])) ? $this->_rootref['UA_SWATCH'] : ''; ?>' + field, '_swatch', 'height=150, resizable=yes, scrollbars=no, width=636');
	<?php } ?>
	return false;
}
