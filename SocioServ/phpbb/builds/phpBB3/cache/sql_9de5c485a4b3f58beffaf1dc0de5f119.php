...
/* SELECT image_name, image_filename, image_lang, image_height, image_width FROM phpbb_styles_imageset_data WHERE imageset_id = 1 AND image_lang IN('en', '') */

$expired = (time() > 1193746069) ? true : false;
if ($expired) { return; }
