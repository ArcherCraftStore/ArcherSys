...
/** 
*
* acp_permissions [Česky]
*
* @package language
* @version $Id: permissions.php,v 1.34 2007/01/24 00:58:45 shs Exp $
...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Používají se k vytvoření různých předdefinovaných rolí, které využívají všechny druhy oprávnění a lze je využít při nastavování ostatních druhů oprávnění. Výchozí předdefinované role by měly pokrýt potřeby velkých i malých diskuzních fór, v opačném případě můžete přidávat/upravovat/mazat další role podle vlastních potřeb.</p>
	...
	'ACP_ADMINISTRATORS_EXPLAIN'				=> 'Zde můžete přidělit administrátorská práva uživatelům nebo skupinám. Všichni uživatelé s administrátorskými pravomocemi mohou nahlížet do Ovládacího panelu fóra.',
	...
	'ACP_GLOBAL_MODERATORS_EXPLAIN'				=> 'Zde můžete přiradit moderátorské pravomoce pro celé fórum uživatelům nebo skupinám. Tito moderátoři jsou shodní s běžnými, nicméně mají práva ke všem sekcím na fóru.',
  ...
  'AUTH_UPDATED'				=> 'Oprávnění byla aktualizována.',
	...
	'ROLE'							=> 'Role',
	'ROLE_ADD_SUCCESS'				=> 'Role byla úspěšně přidána.',
	'ROLE_ASSIGNED_TO'				=> 'Uživatelé/skupiny byli přiřazeni k %s',
	'ROLE_DELETED'					=> 'Role byla úspěšně odstraněna.',
	...
	'ROLE_DESCRIPTION_FORUM_BOT'			=> 'Tato role je doporučena pro boty a vyhledavací roboty.',
	'ROLE_DESCRIPTION_FORUM_FULL'			=> 'Může využívat všech možností fóra, včetně odesílaní Důležitých témat a Oznámení. Také může ignorovat časový interval pro odeslání příspěvků.<br />Není doporučeno pro bežné uživatele.',
	'ROLE_DESCRIPTION_FORUM_LIMITED'		=> 'Může využít některé možnosti fóra, ale nemůže připojovoat přílohy a používat ikony témat.',
	...
	'ROLE_DESCRIPTION_FORUM_POLLS'			=> 'Stejné jako Bežný přístup, ale může zakládat hlasování.',
	...
	'ROLE_EDIT_SUCCESS'				=> 'Role byla úspěšně upravena.',
	...
	'TRACE_RESULT'					=> 'Sledovat výsledek',
	...
	'USER_IS_MEMBER_OF_DEFAULT'		=> 'je členem následujících výchozích skupin',
