...
$lang = array_merge($lang, array(
	...
	'BBCODE_HELPLINE_EXPLAIN'	=> 'Dette felt indeholder mouseover-teksten for BBkoden.',
	...
	'BBCODE_OPEN_ENDED_TAG'		=> 'Din tilpassede BBkode skal indholde både en åbnings- og en afslutningstag.',
	'BBCODE_TAG'				=> 'Tag',
	...
	'BBCODE_USAGE'				=> 'BBkode-anvendelse',
	...
	'HTML_REPLACEMENT_EXAMPLE'		=> '&lt;span style="background-color:{COLOR};"&gt;{TEXT}&lt;/span&gt;<br /><br />&lt;span style="font-family:{SIMPLETEXT1};"&gt;{SIMPLELTEXT2}&lt;/span&gt;',
	...
	'tokens'	=>	array(
		'TEXT'			=> 'Enhver tekst, inklusive udenlandske bogstaver, tal osv... Du bør ikke anvende disse som tokens i HTML tags. Brug i stedet IDENTIFIER eller SIMPLETEXT.',
...
$lang = array_merge($lang, array(
	...
	'ICON_NONE_ADDED'		=> 'Ingen ikoner blev tilføjet.',
	...
	'ICON_NONE_EDITED'		=> 'Ingen ikoner blev opdateret.',
	...
	'SMILIES_LOCATION'			=> 'Smiley placering',
	'SMILIES_NOT_DISPLAYED'		=> 'Følgende smilies vises ikke på siden hvor indlæg skrives',
	'SMILIES_ORDER'				=> 'Smiley orden',
	'SMILIES_URL'				=> 'Smiley billedfil',
	'SMILIES_WIDTH'				=> 'Smiliebredde',
...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'Fra dette kontrolpanel kan du tilføje, rette og fjerne ord som automatisk skal censureres på dine fora. Ydermere vil brugernavne der indeholder disse ord ikke kunne tilmeldes. (*) kan anvendes i ord-feltet som ubekendt, f.eks. vil *test* matche detestable, test* ville matche testing, *test ville matche detest.',
	'ADD_WORD'				=> 'Tilføj nyt ord',

	'EDIT_WORD'		=> 'Ret ord-censor',
	...
	'UPDATE_WORD'	=> 'Opdater ord-censor',

	'WORD'				=> 'Ord',
	'WORD_ADDED'		=> 'Ord-censoren er korrekt tilføjet.',
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Herfra kan du administrere hvilke brugernavne det ikke er tilladt at bruge. De forbudte brugernavns-definitioner kan indeholde (*) som ubekendt. Bemærk venligst at du ikke kan angive brugernavne som allerede er registererede, du må først slette den pågældende bruger og derefter forbyde navnet.',
	...
	'DISALLOWED_ALREADY'		=> 'Navnet du indtastede kunne ikke forbydes. Det findes enten allerede i listen, findes i ord-censorlisten, eller et matchende brugernavn er allerede til stede.',
...
$lang = array_merge($lang, array(
	...
	'IS_NOT_TRANSLATED_EXPLAIN'	=> 'Årsag er <strong>ikke</strong> blevet oversat. Hvis du ønsker at bidrage med en oversat version, angives den korrekte nøgle fra sprogfilernes rapportér årsager sektion.',
	'IS_TRANSLATED'			=> 'Årsag er blevet oversat',
	'IS_TRANSLATED_EXPLAIN'	=> 'Årsag er blevet oversat. Hvis titlen du angiver her er specificeret i sprogfilernes rapportér årsager sektion, vil den oversatte titel og beskrivelse blive anvendt.',
	...
	'REASON_ADD'			=> 'Tilføj rapport-/afvisningsårsag',
	'REASON_ADDED'			=> 'Rapport-/afvisningsårsag korrekt tilføjet.',
	...
	'REASON_EDIT'			=> 'Rediger rapport-/afvisningsårsag',
	...
	'REASON_REMOVED'		=> 'Rapport-/afvisningsårsag korrekt fjernet.',
	'REASON_TITLE'			=> 'Årsagstitel',
	'REASON_TITLE_TRANSLATED'	=> 'Vist årsagstitel',
	'REASON_UPDATED'		=> 'Rapport-/afvisningsårsag korrekt opdateret',
