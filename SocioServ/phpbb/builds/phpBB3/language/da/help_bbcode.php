...
$help = array(
	...
	array(
		0 => 'Hvad er BBkode?',
		1 => 'BBkode er en speciel implementering af HTML. Hvorvidt du aktuelt har muligheden for at anvende BBkode i dine indlæg i dette forum, er defineret af administratoren. Du kan selv fravælge denne mulighed pr. emne når du skriver et indlæg. BBkode skrives på samme måde som HTML, hvor teksten omsluttes af en start- og en slutkode, koderne er omsluttet af hak parenteser [ og ] i stedet for < og > og de tilbyder større kontrol over hvor og hvordan teksten præsenteres. Afhængig af den skabelon der anvendes på forummet, er der direkte adgang til en guide, mens du skriver en besked. Selv med denne nyttige funktion, vil du sikkert finde nedenstående vejledning mere uddybende.'
	),
	array(
		0 => '--',
		1 => 'Tekstformatering'
	...
	array(
		...
		1 => 'BBkode indeholder tags som giver mulighed for hurtigt at ændre på tekstens basale udseende. Her er nogle eksempler:<ul><li>For at lave fed skrift, omsluttes teksten af <strong>[b][/b]</strong>, f.eks.: <br /><br /><strong>[b]</strong>Hej<strong>[/b]</strong><br /><br />bliver til: <strong>Hej</strong></li><br/><li>For at lave en understregning, brug <strong>[u][/u]</strong>, f.eks.:<br /><br /><strong>[u]</strong>Godaften<strong>[/u]</strong><br /><br />bliver til: <span style="text-decoration: underline">Godaften</span></li><br /><li>For at lave kursiv tekst, brug <strong>[i][/i]</strong>, f.eks.:<br /><br />Det er <strong>[i]</strong>smukt!<strong>[/i]</strong><br /><br />giver: Det er <i>smukt!</i></li></ul>'
	),
	array(
	...
	array(
		0 => '--',
		1 => 'Citére og skrive tekst med fast bredde'
	),
	array(
		0 => 'Citére tekst i svar',
		1 => 'Der er to måder du kan citére tekst, med eller uden reference.<ul><li>Bemærk, når du anvender citér funktionen for at svare på et indlæg, bliver indlægget du citérer tilføjet i dit eget indlæg indrammet i en <strong>[quote=&quot;&quot;][/quote]</strong> blok. Denne metode giver dig mulighed for at citére en person eller hvad du ellers måtte vælge! For, for eksempel at citére en stump tekst skrevet af Skovsgaard, skal du skrive sådan:<br /><br /><strong>[quote=&quot;skovsgaard&quot;]</strong>Skovsgaards tekst skrives her<strong>[/quote]</strong><br /><br />"skovsgaard skrev:" bliver automatisk tilføjet som overskrift i tekstblokken. Husk at du <strong>skal</strong> sætte anførselstegnene udenom det navn du vil citére.</li><li>Den anden metode giver mulighed for at citére hvad eller hvem som helst. Her skal teksten bare omsluttes af <strong>[quote][/quote]</strong> tags. Når indlægget vises, ses det i en tekstblok med "Citat" som overskrift.</li></ul>'
	),
	array(
	...
	array(
		...
		1 => 'BBkode supporterer to slags lister, med hhv. punkttegn og med tal/bogstaver. En liste med punkttegn viser hver linie efter hinanden, hver linie starter med et identisk punkt/karakter. For at lave denne liste skal du bruge <strong>[list][/list]</strong> og definere hver ny linie i listen med <strong>[*]</strong>. Hvis du for eksempel vil lave en liste over dine favoritfarver kan du skrive::<br /><br /><strong>[list]</strong><br /><strong>[*]</strong>Rød<br /><strong>[*]</strong>Blå<br /><strong>[*]</strong>Gul<br /><strong>[/list]</strong><br /><br />Det vil resultere i denne liste:<ul><li>Rød</li><li>Blå</li><li>Gul</li></ul>'
	),
	array(
		0 => 'Opstilling med tal/bogstaver',
		1 => 'Den anden type liste giver dig kontrol over hvad der angives for hver linie. For at lave denne liste skal du bruge <strong>[list=1][/list]</strong> for at lave en nummereret liste og alternativt <strong>[list=a][/list]</strong> for en alfabetisk. Som med den første type liste, defineres ny linie med <strong>[*]</strong>. For eksempel:<br /><br /><strong>[list=1]</strong><br /><strong>[*]</strong>Gå på indkøb<br /><strong>[*]</strong>Køb en ny computer<br /><strong>[*]</strong>Band over computeren når den strejker<br /><strong>[/list]</strong><br /><br />vil resultere i denne opstilling:<ol style="list-style-type: arabic-numbers"><li>Gå på indkøb</li><li>Køb en ny computer</li><li>Band over computeren når den strejker</li></ol><br />For den alfabetiske liste bruger du:<br /><br /><strong>[list=a]</strong><br /><strong>[*]</strong>Den første mulighed<br /><strong>[*]</strong>Den anden mulighed<br /><strong>[*]</strong>Den tredje mulighed<br /><strong>[/list]</strong><br /><br />Bliver til<ol style="list-style-type: lower-alpha"><li>Den første mulighed</li><li>Den anden mulighed</li><li>Den tredje mulighed</li></ol>'
	),
	array(
		0 => '--',
		1 => 'Oprette links'
	...
	array(
		...
		1 => 'BBkode indeholder en tag som muliggør at indkludere et billede i dine indlæg. Der er to meget vigtige ting at huske, når denne tag bruges: For det første er der mange brugere, der ikke sætter pris på masser af billeder i indlæg og beskeder, og for det andet skal dette billede du ønsker at inkludere allerede være tilgængeligt på Internettet (det er ikke nok at det ligger lokalt på PC, medmindre du også bruger den som webserver!). For at vise et billede, skal du omfatte linket der peger på billedet med disse tags <strong>[img][/img]</strong>. For eksempel:<br /><br /><strong>[img]</strong>http://www.google.com/intl/en_ALL/images/logo.gif<strong>[/img]</strong><br /><br />Som beskrevet under links ovenover, kan du omfatte et billede med en links tag <strong>[url][/url]</strong> hvis du vil, f.eks.<br /><br /><strong>[url=http://www.google.com/][img]</strong>http://www.google.com/intl/en_ALL/images/logo.gif<strong>[/img][/url]</strong><br /><br />som vil se sådan ud:<br /><br /><a href="http://www.google.com/"><img src="http://www.google.com/intl/en_ALL/images/logo.gif" alt="" /></a>'
	),
	array(
		0 => 'Vedhæfte filer i et indlæg',
		1 => 'Filer kan vedhæftes alle steder i et indlæg ved at bruge <strong>[attachment=][/attachment]</strong> BBkoden, hvis board administratoren har åbnet for denne mulighed og du har de rette tilladelser til at vedhæfte filer. Når filen er vedhæftet dit indlæg, er der lige under dit indlæg, i samme skærmbillede, en dropdown menu (eller alternativt en knap), hvor du kan vælge at placere filen inline, førnævnte BBkode tilføjes automatisk med denne.'
	),
	array(
		0 => '--',
		1 => 'Andet'
