...
$lang = array_merge($lang, array(
	...
	'ATTACH_QUOTA_REACHED'		=> 'Beklager, boardets kvote for vedhæftede filer er opbrugt.',
	'ATTACH_SIG'				=> 'Vedhæft en signatur (signaturer kan rettes via bruger kontrolpanelet)',
	...
	'BBCODE_F_HELP'				=> 'Fontstørrelse: [size=x-small]lille tekst[/size]',
	...
	'BBCODE_Q_HELP'				=> 'Citér tekst: [quote]tekst[/quote]',
	...
	'BUMP_ERROR'				=> 'Du kan ikke placére emnet øverst så hurtigt efter sidste indlæg.',
	...
	'DISABLE_BBCODE'			=> 'Slå BBkode fra',
	'DISABLE_MAGIC_URL'			=> 'Behandel ikke URL\'er automatisk',
	'DISABLE_SMILIES'			=> 'Slå smilies fra',
	...
	'LOAD_DRAFT_EXPLAIN'		=> 'Her kan du vælge den kladde du vil skrive videre på. Dit nuværende indlæg vil blive annulleret, alt nuværende indlægsindhold vil blive slettet. Vælg "Gemte kladder" i bruger kontrolpanelet.',
	...
	'MESSAGE_BODY_EXPLAIN'		=> 'Indtast dit indlæg hér, det må ikke indeholde mere end <strong>%d</strong> tegn.',
	'MESSAGE_DELETED'			=> 'Dette indlæg er blevet slettet.',
	'MORE_SMILIES'				=> 'Vis flere smilies',

	'NOTIFY_REPLY'				=> 'Send mig en email når der skrives et svar',
	...
	'PHP_SIZE_OVERRUN'			=> 'Den vedhæftede fil er for stor, den maksimale filstørrelse er %d MB.<br />Bemærk venligst at dette er sat i php.ini og kan ikke tilsidesættes.',
	'PLACE_INLINE'				=> 'Placér inline',
	...
	'POLL_OPTIONS_EXPLAIN'		=> 'Placér hver mulighed på en ny linie. Du kan indtaste op til <strong>%d</strong> muligheder.',
	'POLL_OPTIONS_EDIT_EXPLAIN'	=> 'Placér hver mulighed på en ny linie. Du kan indtaste op til <strong>%d</strong> muligheder. Hvis du sletter eller tilføjer muligheder, nulstilles alle afgivne stemmer.',
	...
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Indtast 0 eller lad være tom for aldrig udløbende opslag/bekendtgørelser.',
	...
	'UNGLOBALISE_EXPLAIN'		=> 'For at ændre dette emne tilbage fra at være et globalt til et normalt emne, skal du vælge i hvilket forum du ønsker at dette emne skal vises.',
	'UPDATE_COMMENT'			=> 'Opdatér kommentar',
