...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE'				=> 'Din konto er oprettet. Men dette board kræver kontoaktivering, så en aktiveringsnøgle er sendt til den emailadresse du fremsendte. Se venligst din email for yderligere information.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Din konto er oprettet. Men dette board kræver kontoaktivering af administratorerne. En email er blevet sendt til dem og du vil blive informeret når din konto er blevet aktiveret.',
	...
	'ADD_TO'						=> 'Tilføj [Til]',
	'ADMIN_EMAIL'					=> 'Administratorer kan kontakte mig pr. email',
	...
	'AVATAR_EXPLAIN'				=> 'Maksimale dimensioner; bredde: %1$d pixels, højde: %2$d pixels, filstørrelse: %3$dkB.',
	...
	'BOARD_DATE_FORMAT'			=> 'Mit dato format',
	...
	'BOARD_STYLE'				=> 'Min board typografi',
	...
	'CONFIRM_EXPLAIN'			=> 'For at hindre automatiske spamtilmeldinger på boardet, bedes du indtaste bekræftelseskoden vist i nedenstående billede. Hvis du er synshandicappet eller på anden måde ikke kan læse koden, bedes du venligst kontakte %sboard administratoren%s.',
	...
	'DEFAULT_BBCODE'			=> 'Slå BBkode til som standard',
	'DEFAULT_NOTIFY'			=> 'Advisér mig ved svar som standard',
	'DEFAULT_SMILIES'			=> 'Slå smilies til som standard',
	...
	'DEMOTE_SELECTED'			=> 'Degradér valgte',
	...
	'EMAIL_REMIND'				=> 'Emailadressen der er tilknyttet din brugerkonto. Hvis du ikke har ændret denne i bruger kontrolpanelet, er det den samme emailadresse som den du tilmeldte dig med.',
	...
	'EXPORT_AS_XML'				=> 'Eksportér som XML',
	'EXPORT_AS_CSV'				=> 'Eksportér som CSV',
	'EXPORT_AS_CSV_EXCEL'		=> 'Eksportér som CSV (Excel)',
	'EXPORT_AS_TXT'				=> 'Eksportér som TXT',
	'EXPORT_AS_MSG'				=> 'Eksportér som MSG',
	'EXPORT_FOLDER'				=> 'Udfør',
	...
	'FIELD_TOO_SMALL'			=> 'Værdien af "%1$s" er for lille, en minimum værdi på %2$d er påkrævet.',
	'FIELD_TOO_LARGE'			=> 'Værdien af "%1$s" er for stor, en maksimum værdi på %2$d er tilladt.',
	...
	'FOE_MESSAGE'				=> 'Besked fra ignoreret bruger',
	...
	'FOES_UPDATED'				=> 'Din ignorérliste blev opdateret.',
	...
	'HIDE_ONLINE'				=> 'Skjul min online status',
	'HIDE_ONLINE_EXPLAIN'		=> 'Ændres indstillingen, bliver din nye online status først effektiv ved næste besøg på boardet.',
	'HOLD_NEW_MESSAGES'			=> 'Acceptér ikke nye beskeder (Nye beskeder vil blive holdt tilbage indtil tilstrækkelig plads er disponibel)',
	...
	'LINK_REMOTE_AVATAR_EXPLAIN'=> 'Indtast URL\'en for stedet der indeholder avatar billedet som du ønsker at linke til.',
	'LINK_REMOTE_SIZE'			=> 'Avatar dimensioner',
	'LINK_REMOTE_SIZE_EXPLAIN'	=> 'Angiv bredden og højden af avataren, lad være tom for at forsøge automatisk verifikation.',
	'LOGIN_EXPLAIN_UCP'			=> 'Log venligst ind for adgang til bruger kontrolpanelet.',
	'LOGIN_REDIRECT'			=> 'Du er blevet logget ind.',
	'LOGOUT_FAILED'				=> 'Du blev ikke logget ud, da anmodningen ikke matchede din session. Kontakt venligst board administratoren hvis disse problemer fortsætter.',
	'LOGOUT_REDIRECT'			=> 'Du er blevet logget ud.',

	'MARK_IMPORTANT'			=> 'Markér/afmarkér som vigtig',
	'MARKED_MESSAGE'			=> 'Markeret besked',
	'MAX_FOLDER_REACHED'		=> 'Maksimalt antal tilladte brugerdefinerede mapper nået.',
	'MESSAGE_BY_AUTHOR'			=> 'af',
	'MESSAGE_COLOURS'			=> 'Besked farver',
	...
	'NOTIFY_ON_PM'				=> 'Advisér mig ved nye private beskeder',
	'NOT_ADDED_FRIENDS_ANONYMOUS'	=> 'Du kan ikke tilføje den anonyme bruger til din venneliste.',
	'NOT_ADDED_FRIENDS_FOES'	=> 'Du kan ikke tilføje brugere til din venneliste, som er på din ignorérliste.',
	'NOT_ADDED_FRIENDS_SELF'	=> 'Du kan ikke tilføje dig selv til din venneliste.',
	'NOT_ADDED_FOES_MOD_ADMIN'	=> 'Du kan ikke tilføje administratorer eller redaktører til din ignorérliste.',
	'NOT_ADDED_FOES_ANONYMOUS'	=> 'Du kan ikke tilføje den anonyme bruger til din ignorérliste.',
	'NOT_ADDED_FOES_FRIENDS'	=> 'Du kan ikke tilføje brugere til din ignorérliste som er på din venneliste.',
	'NOT_ADDED_FOES_SELF'		=> 'Du kan ikke tilføje dig selv til din ignorérliste.',
	'NOT_AGREE'					=> 'Jeg accepterer ikke disse betingelser',
	'NOT_ENOUGH_SPACE_FOLDER'	=> 'Modtage mappen "%s" synes at være fuld. Den anmodede handling er ikke gennemført.',
	...
	'NO_EMAIL_USER'				=> 'Email/brugernavn informationen angivet kunne ikke findes.',
	...
	'PASSWORD_UPDATED'			=> 'Dit kodeord er blevet sendt til din oprindelige emailadresse.',
	...
	'RULE_REMOVED_MESSAGE'		=> 'En privat besked er blevet fjernet på grund af privat besked filtre.',
	'RULE_REMOVED_MESSAGES'		=> '%d private beskeder er blevet fjernet på grund af privat besked filre.',
	...
	'TIMEZONE'					=> 'Tidszone',
	'TO'						=> 'Til',
	'TOO_MANY_RECIPIENTS'		=> 'For mange modtagere.',
	...
	'UCP_MAIN'					=> 'Oversigt',
	'UCP_MAIN_ATTACHMENTS'		=> 'Administrér vedhæftede filer',
	...
	'UCP_PREFS_PERSONAL'		=> 'Redigér globale indstillinger',
	'UCP_PREFS_POST'			=> 'Redigér skriveindstillinger',
	'UCP_PREFS_VIEW'			=> 'Redigér visningsindstillinger',
	...
	'UCP_PM_POPUP_TITLE'		=> 'Privat besked popup',
	'UCP_PM_UNREAD'				=> 'Ikke læste beskeder',
	'UCP_PM_VIEW'				=> 'Vis beskeder',

	'UCP_PROFILE'				=> 'Profil',
	'UCP_PROFILE_AVATAR'		=> 'Redigér avatar',
	'UCP_PROFILE_PROFILE_INFO'	=> 'Redigér profil',
	'UCP_PROFILE_REG_DETAILS'	=> 'Redigér kontoindstillinger',
	'UCP_PROFILE_SIGNATURE'		=> 'Redigér signatur',

	'UCP_USERGROUPS'			=> 'Brugergrupper',
	'UCP_USERGROUPS_MEMBER'		=> 'Redigér medlemskaber',
	'UCP_USERGROUPS_MANAGE'		=> 'Administrér grupper',
	...
	'UCP_WELCOME'					=> 'Velkommen til bruger kontrolpanelet. Herfra kan du overvåge, se og opdatere din profil, indstillinger samt overvågede fora og emner. Du kan også sende private beskeder til andre brugere (hvis tilladt). Læs venligst enhver bekendtgørelse før du fortsætter.',
	'UCP_YIM'						=> 'Yahoo Messenger',
	'UCP_ZEBRA'						=> 'Venner og ignorerede brugere',
	'UCP_ZEBRA_FOES'				=> 'Administrér ignorerede brugere',
	'UCP_ZEBRA_FRIENDS'				=> 'Administrér venner',
	...
	'VIEW_TOPICS_DIR'			=> 'Vis emnesorteringnøgle',
	...
	'WATCHED_EXPLAIN'			=> 'Nedenfor er en liste over fora og emner du overvåger. Du vil blive adviseret om nye indlæg i begge. For at stoppe overvågning markér forummet eller emnet og tryk bagefter på <em>Stop overvågning af markeret</em> knappen.',
	...
	'PM_ACTION' => array(
		'PLACE_INTO_FOLDER'	=> 'Placér i mappe',
		'MARK_AS_READ'		=> 'Markér som læst',
		'MARK_AS_IMPORTANT'	=> 'Markér besked',
		'DELETE_MESSAGE'	=> 'Slet besked'
	),
	'PM_CHECK' => array(
		'SUBJECT'	=> 'Vedrørende',
