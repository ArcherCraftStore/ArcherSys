...
$lang = array_merge($lang, array(
	...
	'PRIVACY_POLICY'		=> 'Diese Richtlinie beschreibt, wie „%1$s“ und ggf. verbundene Institutionen (im Folgenden „das Board“) und phpBB die Daten verwenden, die während deines Foren-Besuchs gesammelt werden.<br />
	<br />
	Deine Daten werden auf zwei verschiedene Arten gesammelt. Zum einen erstellt phpBB bei deinem Besuch des Boards mehrere Cookies. Cookies sind kleine Textdateien, die dein Browser als temporäre Dateien ablegt. Zwei dieser Cookies enthalten eine eindeutige Benutzer-Nummer (Benutzer-ID) sowie eine anonyme Sitzungs-Nummer (Session-ID), die dir von phpBB automatisch zugewiesen wird. Ein drittes Cookie wird erstellt, sobald du Themen besucht hast und wird dazu verwendet, Informationen über die von dir gelesenen Beiträge zu speichern, um die ungelesenen Beiträge markieren zu können. Während deines Besuchs können auch Cookies außerhalb der phpBB-Software erzeugt werden; doch liegt dies außerhalb des Geltungsbereichs dieser Richtlinien, die nur die Seiten der phpBB-Software umfasst.<br />
	<br />
	Zum anderen werden deine Daten durch die Übermittlung an den Betreiber gesammelt. Dies betrifft — ohne Anspruch auf Vollständigkeit — zum Beispiel Beiträge, die als Gast erstellt werden, Daten, die im Rahmen der Registrierung erfasst werden und die von dir nach deiner Registrierung erstellten Nachrichten.<br />
	<br />
	Dein Benutzerkonto besteht mindestens aus einem eindeutigen Benutzernamen, einem Passwort zur Anmeldung mit diesem Konto und einer persönlichen und gültigen E-Mail-Adresse. Die Daten deines Benutzerkontos sind durch die Datenschutzrichtlinien geschützt, die in dem Land gültig sind, in dem das Board betrieben wird. Bei allen darüber hinausgehenden Daten ist es die Entscheidung des Betreibers, in wie weit diese verpflichtend anzugeben oder optional sind. Du kannst festlegen, welche Informationen deines Profils öffentlich zugänglich sind. Des Weiteren kannst du auswählen, ob du automatisch durch die phpBB-Software generierte E-Mails erhalten möchtest.<br />
	<br />
...
$lang = array_merge($lang, array(
	'ACCOUNT_ACTIVE'				=> 'Dein Benutzerkonto wurde aktivert. Vielen Dank für deine Registrierung.',
	...
	'DELETE_ATTACHMENT_CONFIRM'	=> 'Bist du sicher, dass du diesen Dateianhang löschen möchtest?',
	'DELETE_ATTACHMENTS_CONFIRM'=> 'Bist du sicher, dass du diese Dateianhänge löschen möchtest?',
	'DELETE_AVATAR'				=> 'Lösche Bild',
	'DELETE_COOKIES_CONFIRM'	=> 'Bist du sicher, dass du alle Cookies des Boards löschen möchtest?',
	'DELETE_MARKED_PM'			=> 'Lösche markierte Nachrichten',
	'DELETE_MARKED_PM_CONFIRM'	=> 'Bist du sicher, dass du alle markierten Nachrichten löschen möchtest?',
	'DELETE_OLDEST_MESSAGES'	=> 'Lösche älteste Nachrichten',
	'DELETE_MESSAGE'			=> 'Lösche Nachricht',
	'DELETE_MESSAGE_CONFIRM'	=> 'Bist du sicher, dass du diese Private Nachricht löschen möchtest?',
	'DELETE_MESSAGES_IN_FOLDER'	=> 'Lösche alle Nachrichten im zu löschenden Ordner',
	'DELETE_RULE'				=> 'Lösche Regel',
	'DELETE_RULE_CONFIRM'		=> 'Bist du sicher, dass du diese Regel entfernen möchtest?',
	...
	'REMOVE_SELECTED_BOOKMARKS_CONFIRM'	=> 'Bist du sicher, dass du alle ausgewählten Lesezeichen entfernen möchtest?',
	'REMOVE_BOOKMARK_MARKED'			=> 'Markierte Lesezeichen entfernen',
	'REMOVE_FOLDER'						=> 'Ordner löschen',
	'REMOVE_FOLDER_CONFIRM'				=> 'Bist du sicher, dass du diesen Ordner löschen möchtest?',
	'RENAME'							=> 'Umbenennen',
