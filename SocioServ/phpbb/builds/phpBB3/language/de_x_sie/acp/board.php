...
*
* @package language
* @version $Id: board.php 288 2007-08-24 20:47:32Z philipp $
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> 'Die Syntax entspricht dem der <a href="http://www.php.net/date"><code>date()</code></a>-Funktion von PHP.',
	...
	'SYSTEM_DST'					=> 'Sommerzeit aktivieren',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_BIRTHDAYS_EXPLAIN'	=> 'Aktiviert die Eingabe von Geburtstagen und die Anzeige des Alters im Profil. Beachten Sie, dass für die Geburtstagsanzeige in der Foren-Übersicht ein getrennte Option in den Einstellungen zur Serverlast existiert.',
...
$lang = array_merge($lang, array(
	...
	'MAX_AVATAR_SIZE_EXPLAIN'		=> 'Höhe &times; Breite in Pixel',
	...
	'MIN_AVATAR_SIZE_EXPLAIN'		=> 'Höhe &times; Breite in Pixel',
));
...
$lang = array_merge($lang, array(
	...
	'QUOTE_DEPTH_LIMIT_EXPLAIN'		=> 'Die maximale Zahl an ineinander verschachtelten Zitaten in einem Beitrag. Um keine Begrenzung festzulegen, stellen Sie als Wert 0 ein.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'	=> 'Diese Einstellung legt fest, ob Benutzer sofortigen Zugang zum Board haben, oder ob eine Bestätigung erforderlich ist. Sie können neue Registrierungen auch komplett deaktivieren.',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'		=> 'Hier können Sie die Einstellungen zu CAPTCHA und dem visuellem Bestätigungscode vornehmen.',
	...
	'CAPTCHA_GD_X_GRID_EXPLAIN'				=> 'Verwenden Sie einen niedrigeren Wert, um das GD-basierte CAPTCHA schwerer zu machen. 0 deaktiviert das Hintergrund-Rauschen auf der x-Achse.',
	'CAPTCHA_GD_Y_GRID'						=> 'GD CAPTCHA Hintergrund-Rauschen Y-Achse',
	'CAPTCHA_GD_Y_GRID_EXPLAIN'				=> 'Verwenden Sie einen niedrigeren Wert, um das GD-basierte CAPTCHA schwerer zu machen. 0 deaktiviert das Hintergrund-Rauschen auf der y-Achse.',

	'CAPTCHA_PREVIEW_MSG'					=> 'Ihre Änderungen an den Einstellungen des Bestätigungscodes wurden nicht gespeichert. Dies ist nur eine Vorschau.',
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'So wird der Bestätigungscode mit den aktuellen Einstellungen aussehen. Sie können ihn mit „Vorschau“ aktualisieren. Beachten Sie, dass der Bestätigungscode zufällig erstellt wird und von dem hier angezeigten abweichen wird.',
...
$lang = array_merge($lang, array(
	...
	'LDAP_USER_EXPLAIN'				=> 'Lassen Sie das Feld für eine anonyme Verbindung frei. Wenn ausgefüllt, wird phpBB den angegebenen Benutzer dazu verwenden, um sich für die Suche nach dem passenden Benutzer wie <samp>uid=Benutzername,ou=MeineOrganisationseinheit,o=MeineFirma,c=DE</samp> anzumelden. Erforderlich bei Active Directory-Servern.',
...
$lang = array_merge($lang, array(
	...
	'FORWARDED_FOR_VALID_EXPLAIN'	=> 'Sitzungen werden nur fortgesetzt, wenn die übermittelte <var>X_FORWARDED_FOR</var>-Kopfzeile mit der der letzen Anfrage identisch ist. Die in <var>X_FORWARDED_FOR</var> angegebene Adresse wird ebenfalls auf Sperrung geprüft.',
...
$lang = array_merge($lang, array(
	...
	'SMTP_PASSWORD_EXPLAIN'			=> 'Geben Sie nur ein Passwort ein, wenn Ihr SMTP-Server dies erfordert.',
	'SMTP_PLAIN'					=> 'PLAIN',
...
$lang = array_merge($lang, array(
	...
	'ERR_JAB_AUTH'			=> 'Autorisierung am Jabber-Server fehlgeschlagen.',
	...
	'JAB_USERNAME_EXPLAIN'		=> 'Geben Sie einen bereits registrierten Benutzernamen an. Der Benutzername wird nicht auf Gültigkeit geprüft.',
));
