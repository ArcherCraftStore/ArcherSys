...
/**
*
* acp common [Deutsch — Sie]
*
* @package language
* @version $Id: common.php 288 2007-08-24 20:47:32Z philipp $
...
$lang = array_merge($lang, array(
	...
	'ACP_GLOBAL_MODERATORS'			=> 'Forenübergreifende Moderatoren',
	...
	'ACP_VIEW_GLOBAL_MOD_PERMISSIONS'	=> 'Forenübergreifende Moderations-Berechtigungen anzeigen',
...
$lang = array_merge($lang, array(
	...
	'PURGE_CACHE_CONFIRM'	=> 'Sind Sie sicher, dass Sie den Cache leeren möchten?',
	...
	'RESET_DATE_CONFIRM'			=> 'Sind Sie sicher, dass Sie das Einrichtungsdatum des Boards zurücksetzen wollen?',
	'RESET_ONLINE'					=> 'Besucherrekord zurücksetzen',
	'RESET_ONLINE_CONFIRM'			=> 'Sind Sie sicher, dass Sie den Benutzerrekord zurücksetzen wollen?',
	...
	'RESYNC_POSTCOUNTS_CONFIRM'		=> 'Sind Sie sicher, dass Sie die Beitragszähler resynchronisieren wollen?',
	'RESYNC_POST_MARKING'			=> 'Markierung eigener Beiträge resynchronisieren',
	'RESYNC_POST_MARKING_CONFIRM'	=> 'Sind Sie sicher, dass Sie die Markierung eigener Beiträge resynchronisieren wollen?',
	...
	'RESYNC_STATS_CONFIRM'			=> 'Sind Sie sicher, dass Sie die Statistiken resynchronisieren wollen?',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Dies ist eine Liste der 10 zuletzt registrierten Benutzer, deren Konto inaktiv ist. Eine vollständige Liste ist über den entsprechenden Menüeintrag oder den unten stehenden Link zugänglich, von der aus Sie diese Benutzer aktivieren, löschen oder erinnern (per E-Mail) können.',
...
$lang = array_merge($lang, array(
	...
	'LOG_ACL_ADD_USER_GLOBAL_M_'		=> '<strong>Forenübergreifende Moderationsrechte eines Benutzers hinzugefügt oder geändert</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_M_'		=> '<strong>Forenübergreifende Moderationsrechte einer Gruppe hinzugefügt oder geändert</strong><br />» %s',
	...
	'LOG_ADMIN_AUTH_FAIL'		=> '<strong>Gescheiterter administrative Anmeldung</strong>',
	'LOG_ADMIN_AUTH_SUCCESS'	=> '<strong>Erfolgreicher administrative Anmeldung</strong>',
	...
	'LOG_IMAGESET_LANG_MISSING'		=> '<strong>Grafiksammlung findet „<em>%2$s</em>“-Übersetzung nicht</strong><br />Â» %1$s',
