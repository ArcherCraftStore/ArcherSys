...
*
* @package language
* @version $Id: forums.php 279 2007-07-29 16:05:27Z philipp $
...
$lang = array_merge($lang, array(
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'Im phpBB3 gibt es keine Kategorien, alles ist forenbasiert. Jedes Forum kann eine unbegrenzte Anzahl an Unterforen haben und Sie können festlegen, ob in ihnen Beiträge geschrieben werden dürfen oder nicht (wenn es sich z.&nbsp;B. wie eine frühere Kategorie verhalten soll). Hier können Sie Foren hinzufügen, bearbeiten, löschen, schließen und wieder öffnen wie auch zusätzliche Kontrollfunktionen einstellen. Wenn Ihre Beitrags- und Themeninformationen nicht mehr synchron sind, können Sie das Forum auch resynchronisieren. <strong>Sie müssen passende Berechtigungen erstellen oder kopieren, damit ein neu erstelltes Forum auch angezeigt wird.</strong>',
	...
	'FORUM_IMAGE_EXPLAIN'				=> 'Der Ort eins Bildes, relativ zum phpBB-Hauptverzeichnis, das diesem Forum zusätzlich zugeordnet werden soll.',
	...
	'LIST_INDEX_EXPLAIN'	=> 'Zeigt einen Link zu diesem Forum in der Legende des übergeordneten Forums an.',
	'LOCKED'				=> 'Gesperrt',
