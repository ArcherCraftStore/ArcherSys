...
*
* @package language
* @version $Id: permissions.php 279 2007-07-29 16:05:27Z philipp $
...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		<p>Berechtigungen können sehr granular festgelegt werden. Sie sind in vier zentrale Bereiche aufgeteilt:</p>

		<h2>Allgemeine Berechtigungen</h2>
		<p>Mit diesen werden Berechtigungen forenübergreifend auf das gesamte Board angewandt. Sie sind weiter unterteilt in Benutzerrechte, Gruppenrechte, Administratoren und forenübergreifende Moderatoren.</p>
		...
		<p>Diese Funktion wird verwendet, um die effektiven Berechtigungen anzuzeigen, die Benutzern, Moderatoren (forenspezifisch und forenübergreifend), Administratoren und Foren zugewiesen sind.</p>

		<br />

		<p>Für weitere Informationen über die Einrichtung und Verwaltung von Berechtigungen auf Ihrem phpBB3-Board sehen Sie bitte im <a href="http://www.phpbb.com/support/documentation/3.0/quickstart/quick_permissions.html">Kapitel 1.5 des Quick Start Guide</a> nach.</p>
	',
	...
	'ACL_TYPE_GLOBAL_M_'	=> 'Forenübergreifende Moderator-Berechtigungen',
	...
	'ACP_FORUM_MODERATORS_EXPLAIN'				=> 'Hier können Sie Benutzer und Gruppen zu Forums-Moderatoren ernennen. Um den Zugriff von Benutzern auf Foren zu regeln, Rechte für forenübergreifende Moderatoren festzulegen oder um Administratoren zu ernennen, verwenden Sie bitte die entsprechenden Bereiche.',
	...
	'ACP_GLOBAL_MODERATORS_EXPLAIN'				=> 'Hier können Sie Benutzern oder Gruppen forenübergreifende Moderator-Berechtigungen zuweisen. Diese Moderatoren haben die gleichen Rechte wie gewöhnliche Moderatoren, können jedoch auf jedes Forum des Boards zugreifen.',
	'ACP_GROUPS_FORUM_PERMISSIONS_EXPLAIN'		=> 'Hier können Sie Gruppen Forums-Berechtigungen zuweisen.',
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'Hier können Sie Gruppen globale Rechte (Benutzer-, forenübergreifende Moderatoren- und Administrator-Berechtigungen) zuweisen. Benutzerrechte beinhalten Punkte wie Avatare, den Versand von Privaten Nachrichten usw.; Globale-Moderator-Berechtigungen beinhalten die Bestätigung von Beiträgen, die Verwaltung von Themen und Sperren etc. und Administrations-Berechtigungen beinhalten die Änderung von Berechtigungen, die Definition benutzerdefinierter BBCodes etc. Individuelle Benutzer-Berechtigungen sollten nur in seltenen Fällen verwendet werden; die vorzuziehende Methode ist, die Benutzer in Gruppen aufzunehmen und den Gruppen entsprechende Rechte zuzuweisen.',
	'ACP_ADMIN_ROLES_EXPLAIN'					=> 'Hier können Sie Rollen für Administrator-Berechtigungen verwalten. Rollen sind zugewiesene Berechtigungen; wenn Sie eine Rolle ändern, ändern sich die Rechte aller Elemente, die diese Rolle zugewiesen haben.',
	'ACP_FORUM_ROLES_EXPLAIN'					=> 'Hier können Sie Rollen für Forum-Berechtigungen verwalten. Rollen sind zugewiesene Berechtigungen; wenn Sie eine Rolle ändern, ändern sich die Rechte aller Elemente, die diese Rolle zugewiesen haben.',
	'ACP_MOD_ROLES_EXPLAIN'						=> 'Hier können Sie Rollen für Moderator-Berechtigungen verwalten. Rollen sind zugewiesene Berechtigungen; wenn Sie eine Rolle ändern, ändern sich die Rechte aller Elemente, die diese Rolle zugewiesen haben.',
	'ACP_USER_ROLES_EXPLAIN'					=> 'Hier können Sie Rollen für Benutzer-Berechtigungen verwalten. Rollen sind zugewiesene Berechtigungen; wenn Sie eine Rolle ändern, ändern sich die Rechte aller Elemente, die diese Rolle zugewiesen haben.',
	'ACP_USERS_FORUM_PERMISSIONS_EXPLAIN'		=> 'Hier können Sie Benutzern Foren-Berechtigungen zuweisen.',
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'Hier können Sie Benutzern globale Rechte (Benutzer-, forenübergreifende Moderatoren- und Administrator-Berechtigungen) zuweisen. Benutzerrechte beinhalten Punkte wie Avatare, den Versand von Privaten Nachrichten usw.; Globale-Moderator-Berechtigungen beinhalten die Bestätigung von Beiträgen, die Verwaltung von Themen und Sperren etc. und Administrations-Berechtigungen beinhalten die Änderung von Berechtigungen, die Definition benutzerdefinierter BBCodes etc. Um diese Rechte für eine größere Zahl von Benutzern zu ändern, sollte das Gruppen-Berechtigungssystem verwendet werden. Benutzer-Berechtigungen sollten nur in seltenen Fällen verwendet werden; die vorzuziehende Methode ist, die Benutzer in Gruppen aufzunehmen und den Gruppen entsprechende Rechte zuzuweisen.',
	...
	'ACP_VIEW_GLOBAL_MOD_PERMISSIONS_EXPLAIN'	=> 'Hier können Sie die forenübergreifender Moderator-Berechtigungen anzeigen, die den ausgewählten Benutzern/Gruppen zugewiesen sind.',
	...
	'DELETE_ROLE_CONFIRM'		=> 'Sind Sie sicher, dass Sie diese Rolle löschen wollen? Objekte, die diese Rolle zugewiesen haben, werden ihre Rechte <strong>nicht</strong> verlieren.',
	...
	'ROLE_DESCRIPTION_FORUM_LIMITED'		=> 'Kann die meisten Forums-Funktionen nutzen, kann aber keine Dateianhänge erstellen oder Beitrags-Symbole verwenden.',
	'ROLE_DESCRIPTION_FORUM_LIMITED_POLLS'	=> 'Wie „Begrenzter Zugang“, kann aber auch Umfragen erstellen.',
	'ROLE_DESCRIPTION_FORUM_NOACCESS'		=> 'Kann das Forum weder sehen noch auf es zugreifen.',
	...
	'ROLE_DESCRIPTION_USER_NOPM'			=> 'Hat eingeschränkte Rechte und kann keine Privaten Nachrichten benuten.',
	...
	'TRACE_RESULT'							=> 'Ergebnis verfolgen',
	...
	'TRACE_USER_FOUNDER'					=> 'Der Benutzer hat Gründer-Status, so dass Administrationsrechten immer auf <strong>JA</strong> gesetzt sind.',
