...
*
* @package language
* @version $Id: posting.php 288 2007-08-24 20:47:32Z philipp $
...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		'TEXT'			=> 'Jeder Text, einschließlich fremder Zeichen, Ziffern usw. Sie sollten dieses Token nicht innerhalb von HTML-Tags verwenden, sondern IDENTIFIER oder SIMPLETEXT vorziehen.',
...
$lang = array_merge($lang, array(
	...
	'ICON_NONE_ADDED'		=> 'Kein Beitrags-Symbol wurde hinzugefügt.',
	...
	'ICON_NONE_EDITED'		=> 'Kein Beitrags-Symbol wurde aktualisiert.',
...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'Hier können Sie Begriffe einstellen, die automatisch zensiert werden sollen. Außerdem kann man sich nicht mit diesen Begriffen als Benutzernamen registrieren. Platzhalter (*) sind im Begriffs-Feld erlaubt. *test* wird austesten finden, test* testweise und *test wird Sehtest finden.',
...
$lang = array_merge($lang, array(
	...
	'DISALLOWED_ALREADY'		=> 'Der eingegebene Name konnte nicht verboten werden. Entweder steht er bereits in der Liste der verbotenen Namen oder in der Wortzensur oder ein Benutzer ist mit entsprechendem Namen registriert.',
