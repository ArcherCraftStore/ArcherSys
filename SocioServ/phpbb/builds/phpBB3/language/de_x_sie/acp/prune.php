...
*
* @package language
* @version $Id: prune.php 239 2007-05-28 10:57:29Z philipp $
...
$lang = array_merge($lang, array(
	'ACP_PRUNE_USERS_EXPLAIN'	=> 'Hier können Sie Benutzer Ihres Boards löschen (oder deaktivieren). Dies kann anhand verschiedener Kriterien erfolgen: der Beitragszahl, der letzten Aktivität usw. Die Kriterien können kombiniert werden, so dass Sie Benutzer löschen können, deren letzte Aktivität vor dem 2002-01-01 war und die weniger als 10 Beiträge haben. Alternativ können Sie auch eine Liste von Benutzernamen direkt in das Textfeld eingeben, die anderen Kriterien werden dann ignoriert. Gehen Sie mit diesem Tool vorsichtig um! Wenn ein Benutzer gelöscht ist, gibt es keine Funktion, um diesen Vorgang rückgängig zu machen.',

	'DEACTIVATE_DELETE'			=> 'Deaktivieren oder löschen',
	'DEACTIVATE_DELETE_EXPLAIN'	=> 'Wählen Sie aus, ob der Benutzer deaktiviert oder gelöscht werden soll. Beachten Sie, dass es keine Funktion gibt, um den Vorgang rückgängig zu machen!',
	...
	'LAST_ACTIVE_EXPLAIN'		=> 'Geben Sie ein Datum im Format <kbd>JJJJ-MM-TT</kbd> an.',
	...
	'SELECT_USERS_EXPLAIN'		=> 'Geben Sie hier spezifische Benutzernamen ein. Die oben angegebenen Kriterien werden dann ignoriert.',
...
// Forum Pruning
$lang = array_merge($lang, array(
	'ACP_PRUNE_FORUMS_EXPLAIN'	=> 'Diese Funktion wird alle Themen löschen, zu denen innerhalb der von Ihnen festgelegten Zeit keine neue Beiträge erstellt oder die nicht gelesen wurden. Geben Sie keinen Zeitraum an, so werden alle Beiträge gelöscht. Themen mit Umfragen und Bekanntmachungen werden nur gelöscht, sofern Sie die entsprechenden Optionen aktiviert haben.',
