...
*
* @package language
* @version $Id: styles.php 279 2007-07-29 16:05:27Z philipp $
...
$lang = array_merge($lang, array(
	...
	'CONFIRM_TEMPLATE_CLEAR_CACHE'	=> 'Sind Sie sicher, dass Sie alle gecachten Versionen Ihrer Template-Sammlung löschen möchten?',
	'CONFIRM_TEMPLATE_REFRESH'		=> 'Sind Sie sicher, dass Sie die Template-Daten in der Datenbank mit den Daten des Templates im Dateisystem überschreiben möchten? Dies wird alle Änderungen überschreiben, die mit dem Template-Editor durchgeführt wurden, während das Template in der Datenbank gespeichert war.',
	...
	'DELETE_IMAGESET_EXPLAIN'	=> 'Hier können Sie die ausgewählte Grafiksammlung aus der Datenbank entfernen. Sofern Sie ausreichende Rechte haben, können Sie zusätzlich auswählen, dass die Sammlung auch vom Dateisystem entfernt wird. Beachten Sie, dass es keine Rückgängig-Funktion gibt. Wenn eine Grafiksammlung gelöscht wurde, ist sie nicht mehr verfügbar. Sie sollten daher vorher die Grafiksammlung für zukünftige Zwecke exportieren.',
	...
	'DELETE_TEMPLATE_EXPLAIN'	=> 'Hier können Sie die ausgewählte Template-Sammlung aus der Datenbank entfernen. Sofern Sie ausreichende Rechte haben, können Sie zusätzlich auswählen, dass die Sammlung auch vom Dateisystem entfernt wird. Beachten Sie, dass es keine Rückgängig-Funktion gibt. Wenn ein Template gelöscht wurde, ist es nicht mehr verfügbar. Sie sollten daher vorher die Sammlung für zukünftige Zwecke exportieren.',
	'DELETE_THEME'				=> 'Theme löschen',
	'DELETE_THEME_EXPLAIN'		=> 'Hier können Sie das ausgewählte Theme aus der Datenbank entfernen. Sofern Sie ausreichende Rechte haben, können Sie zusätzlich auswählen, dass das Theme auch vom Dateisystem entfernt wird. Beachten Sie, dass es keine Rückgängig-Funktion gibt. Wenn ein Theme gelöscht wurde, ist es nicht mehr verfügbar. Sie sollten daher vorher die Sammlung für zukünftige Zwecke exportieren.',
	'DETAILS'					=> 'Details',
	...
	'EDIT_DETAILS_TEMPLATE_EXPLAIN'		=> 'Hier können Sie bestimmte Template-Details wie z.&nbsp;B. seinen Namen ändern. Sie können die Möglichkeit haben, den Ablageort der Template-Dateien vom Dateisystem zur Datenbank oder andersrum zu ändern. Diese Option ist abhängig von der PHP-Konfiguration und davon, ob Ihr Webserver in die Template-Dateien schreiben kann.',
	'EDIT_DETAILS_THEME'				=> 'Theme-Details ändern',
	'EDIT_DETAILS_THEME_EXPLAIN'		=> 'Hier können Sie bestimmte Details eines Themes wie z.&nbsp;B. seinen Namen ändern. Sie können die Möglichkeit haben, den Ablageort des Stylesheets vom Dateisystem zur Datenbank oder andersrum zu ändern. Diese Option ist abhängig von der PHP-Konfiguration und davon, ob Ihr Webserver in die Stylesheet-Dateien schreiben kann.',
