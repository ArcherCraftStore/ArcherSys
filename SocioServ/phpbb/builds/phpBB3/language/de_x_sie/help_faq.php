...
*
* @package language
* @version $Id: help_faq.php 288 2007-08-24 20:47:32Z philipp $
...
$help = array(
	...
	array(
		...
		1 => 'In der Beitragsansicht können zwei Bilder unter Ihrem Benutzernamen stehen. Abhängig von dem gewählten Style ist das erste Bild meist mit Ihrem Rang verknüpft: Oft sind dies Sterne, Kästchen oder Punkte, die Ihre Beitragszahl oder Ihren Status im Forum angeben. Das zweite, meist größere Bild darunter, ist auch als „Avatar“ bekannt. Es handelt sich hierbei in der Regel um ein persönliches Bild, welches von Benutzer zu Benutzer unterschiedlich ist. Die Board-Administration kann bestimmen, ob und wie die Benutzer Avatare benutzen können. Wenn Sie keinen Avatar benutzen dürfen, sollten Sie die Board-Administration nach den Gründen dafür fragen.'
	),
	array(
	...
	array(
		...
		1 => 'Die maximal zulässige Zahl von Antwortmöglichkeiten wird durch die Board-Administration festgelegt. Wenn Sie glauben, mehr Antwortmöglichkeiten wie zugelassen zu benötigen, kontaktieren Sie einen Administrator.'
	),
	array(
