...
*
* @package language
* @version $Id: install.php 288 2007-08-24 20:47:32Z philipp $
...
$lang = array_merge($lang, array(
	...
	'COULD_NOT_FIND_PATH'		=> 'Der Pfad zu Ihrem alten Board konnte nicht gefunden werden. Bitte prüfen Sie Ihre Einstellungen und versuchen Sie es erneut.<br />» Angegebener Quell-Pfad: %s',
	...
	'DB_HOST_EXPLAIN'			=> 'DSN steht für Data Source Name und ist nur für ODBC-Installationen relevant.',
	...
	'FINAL_STEP'				=> 'Führe abschließenden Schritt aus',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		<p>Sie haben phpBB %1$s nun erfolgreich installiert. Sie haben nun zwei Optionen, was Sie mit Ihrem frisch installierten phpBB3-Board machen können:</p>
		...
		<p>Wenn Sie unten auf die Schaltfläche klicken, werden Sie zum Administrations-Bereich weitergeleitet. Nehmen Sie sich etwas Zeit, um die verfügbaren Optionen kennen zu lernen. Hilfe zum Gebrauch von phpBB erhalten Sie online über die <a href="http://www.phpbb.com/support/documentation/3.0/">Dokumentation</a> und das <a href="http://www.phpbb.com/community/viewforum.php?f=46">Support-Forum</a>. Für weitere Informationen lesen Sie die <a href="%3$s">README</a>-Datei.<br/><br/><strong>Bitte löschen oder verschieben Sie nun das Installations-Verzeichnis „install“ oder nennen Sie es nun um, bevor Sie Ihr Board benutzen. Solange dieses Verzeichnis existiert, ist nur der Administrations-Bereich zugänglich.</strong></p>',
	'INSTALL_INTRO'				=> 'Willkommen bei der Installation',
// TODO: write some more introductions here
	'INSTALL_INTRO_BODY'		=> 'Dieser Assistent ermöglicht Ihnen die Installation von phpBB auf Ihrem Server.</p><p>Bevor Sie fortsetzen können, benötigen Sie die Daten Ihrer Datenbank. Wenn Sie die Daten Ihrer Datenbank nicht kennen, kontaktieren Sie bitte Ihren Server-Betreiber und fragen Sie nach den Daten. Ohne die Datenbankdaten können Sie nicht fortfahren. Sie benötigen:</p>
	<ul>
	...
	'INST_ERR_DB_NO_FIREBIRD'	=> 'Die installierte Firebird-Version ist älter als 2.0 und muss aktualisiert werden.',
...
// TODO: Write some explanatory introduction text
	...
	'OVERVIEW_BODY'					=> 'Willkommen zu unserem öffentlichen Release Candidate der nächsten Generation von phpBB nach 2.0.x, phpBB 3.0! Diese Veröffentlichung ist für eine breitere Nutzung gedacht, um die letzten Fehler und Probleme finden zu können.</p><p>Bitte lesen Sie <a href="../docs/INSTALL.html">die Installationshinweise</a> für weitere Informationen zur Installation von phpBB3.</p><p><strong style="text-transform: uppercase;">Beachten Sie:</strong> Dies ist <strong style="text-transform: uppercase;">immer noch keine finale</strong> Veröffentlichung. Eventuell wollen Sie bis zur endgültigen Version warten, bevor Sie die Software produktiv einsetzen.</p><p>Dieses Installations-System wird Sie durch die Installation von phpBB, der Konvertierung von einem anderen Software-Paket oder dem Update auf die aktuelle Version von phpBB führen. Für weitere Informationen zu den einzelnen Optionen wählen Sie diese aus dem obigen Menü aus.',
...
// TODO: Write some text on obtaining support
	'SUPPORT_BODY'				=> 'Während der Release Candidate-Phase wird vollständiger Support im <a href="http://www.phpbb.com/community/viewforum.php?f=46">phpBB 3.0.x-Support-Forum</a> angeboten. Wir werden Antworten auf allgemeine Setup-Fragen, Konfigurations- und Konvertierungsprobleme und Unterstützung bei der Bestimmung gängiger Probleme, die hauptsächlich auf Bugs zurückzuführen sind, geben. Wir werden Diskussionen über Modifikationen oder eigene Code-/Style-Änderungen erlauben.</p><p>Für weiterführende Unterstützung verwenden Sie bitte unseren <a href="http://www.phpbb.com/support/documentation/3.0/quickstart/">Quick Start Guide</a> und die <a href="http://www.phpbb.com/support/documentation/3.0/">Dokumentation</a>.</p><p>Um immer die neuesten Informationen zu Updates und Veröffentlichungen zu erhalten, sollten Sie sich für den <a href="http://www.phpbb.com/support/">phpBB Newsletter</a> anmelden.',
	...
	'TABLE_PREFIX_SAME'			=> 'Der Tabellen-Präfix muss mit dem übereinstimmen, der von der Software, von der Sie konvertieren möchten, genutzt wird.<br />» Der angegebene Tabellen-Präfix lautete %s.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Alle Dateien sind auf dem Stand der neuesten phpBB-Version. Sie sollten sich nun <a href="../ucp.php?mode=login">auf Ihrem Board anmelden</a> und prüfen, ob alles einwandfrei funktioniert. Vergessen Sie nicht, das Installations-Verzeichnis „install“ zu löschen, umzubenennen oder zu verschieben!',
	...
	'COLLECTED_INFORMATION'			=> 'Gesammelte Datei-Informationen',
	...
	'CONTINUE_UPDATE_NOW'			=> 'Den Update-Prozess jetzt fortsetzen',
	'CURRENT_FILE'					=> 'Derzeitige Originaldatei',
	...
	'DIFF_SEP_EXPLAIN'					=> 'Ende der aktuellen Datei / Anfang der neuen, aktualisierten Datei',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'	=> 'Die folgenden Dateien wurden nicht geändert und entsprechen den originalen phpBB-Dateien der Version, von der aus Sie updaten wollen.',
	...
	'MERGE_MOD_FILE_OPTION'		=> 'Unterschiede zusammenführen und modifizierten Code bei Konflikten nutzen',
	'MERGE_NEW_FILE_OPTION'		=> 'Unterschiede zusammenführen und neuen Code bei Konflikten nutzen',
	'MERGE_SELECT_ERROR'		=> 'Es wurde keine gültige Methode zum Lösen von Dateikonflikten gewählt.',

	'NEW_FILE'						=> 'Neue, aktualisierte Datei',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Gehen Sie zur <a href="http://www.phpbb.com/downloads/" title="http://www.phpbb.com/downloads/">phpBB.com-Downloadseite</a> und laden Sie das entsprechende „Automatisches-Update-Paket“ herunter.<br /><br /></li>
	...
	'VERSION_CHECK_EXPLAIN'		=> 'Prüft, ob die phpBB-Version, die Sie einsetzen, auf dem neuesten Stand ist.',
	'VERSION_NOT_UP_TO_DATE'	=> 'Ihre phpBB-Version ist nicht auf dem neuesten Stand. Bitte fahren Sie mit der Aktualisierung fort.',
	'VERSION_NOT_UP_TO_DATE_ACP'=> 'Ihre phpBB-Version ist nicht auf dem neuesten Stand<br />Im Folgenden finden Sie einen Link zu der Release-Ankündigung der neuesten Version sowie Informationen, wie Sie Ihre Version aktualisieren können.',
	'VERSION_UP_TO_DATE'		=> 'Ihre Installation ist auf dem neuesten Stand, für Ihre phpBB-Version sind keine Updates verfügbar. Sie können trotzdem fortfahren und die Dateien auf Gültigkeit überprüfen.',
	'VERSION_UP_TO_DATE_ACP'	=> 'Ihre Installation ist auf dem neuesten Stand, für Ihre phpBB-Version sind keine Updates verfügbar. Es ist nicht nötig, die Installation zu aktualisieren.',
...
$lang = array_merge($lang, array(
	...
	'CONFIG_SITE_DESC'				=> 'Ein _kurzer_ Text, der Ihr Forum beschreibt',
	'CONFIG_SITENAME'				=> 'ihredomain.tld',

	'DEFAULT_INSTALL_POST'			=> 'Dies ist ein Beispielsbeitrag Ihrer phpBB3-Installation. Wenn Sie wollen, können Sie ihn, dieses Thema und sogar das Forum löschen, da alles zu funktionieren scheint!',
	...
	'EXT_GROUP_REAL_MEDIA'			=> 'Real Media-Dateien',
	'EXT_GROUP_WINDOWS_MEDIA'		=> 'Windows Media-Dateien',

	'FORUMS_FIRST_CATEGORY'			=> 'Meine erste Kategorie',
	'FORUMS_TEST_FORUM_DESC'		=> 'Dies ist nur ein Testforum.',
	...
	'SMILIES_GEEK'					=> 'Computerfreak / Geek',
	'SMILIES_IDEA'					=> 'Idee',
	...
	'SMILIES_UBER_GEEK'				=> 'Extremer Computerfreak / Uber Geek',
