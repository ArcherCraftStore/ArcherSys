...
$lang = array_merge($lang, array(
	...
	'ACL_VIEW_EXPLAIN'		=> 'Ici vous pouvez voir les permissions effectives de l\'utilisateur/du groupe. Un rectangle rouge indique que l\'utilisateur/le groupe n\'a pas la permission, un rectangle vert indique que l\'utilisateur/le groupe a la permission.',
	'ACL_YES'				=> 'Oui',

	'ACP_ADMINISTRATORS_EXPLAIN'				=> 'Vous pouvez attribuer ici des droits d\'administration à des utilisateurs ou groupes. Tous les utilisateurs avec des permissions d\'administration peuvent accéder au panneau d\'administration.',
	'ACP_FORUM_MODERATORS_EXPLAIN'				=> 'Vous pouvez attribuer ici des utilisateurs et des groupes en tant que modérateurs du forum. Pour attribuer l\'accès des utilisateurs aux forums et pour définir des droits de modération globale ou d\'administration, utilisez la page appropriée.',
	'ACP_FORUM_PERMISSIONS_EXPLAIN'				=> 'Vous pouvez modifier ici le nombre d\'utilisateurs et de groupes pouvant accéder à certains forums. Pour attribuer des modérateurs ou définir des administrateurs, utilisez la page appropriée.',
	'ACP_GLOBAL_MODERATORS_EXPLAIN'				=> 'Vous pouvez attribuer ici les droits de modérateur global aux utilisateurs ou aux groupes. Ces modérateurs sont des modérateurs ordinaires excepté qu\'ils ont accès à tous les forums.',
	...
	'ACP_ADMIN_ROLES_EXPLAIN'					=> 'Vous pouvez gérer ici les modèles des permissions des administrateurs. Les modèles sont des permissions effectives, si vous modifiez un modèle les éléments auxquels ce modèle était assigné verront aussi leurs permissions modifiées.',
	'ACP_FORUM_ROLES_EXPLAIN'					=> 'Vous pouvez gérer ici les modèles des permissions des forums. Les modèles sont des permissions effectives, si vous modifiez un modèle les éléments auxquels ce modèle était assigné verront leurs permissions modifiées aussi.',
	'ACP_MOD_ROLES_EXPLAIN'						=> 'Vous pouvez gérer ici les modèles des permissions des modérateurs. Les modèles sont des permissions effectives, si vous modifiez un modèle les éléments auxquels ce modèle était assigné verront leurs permissions modifiées aussi.',
	'ACP_USER_ROLES_EXPLAIN'					=> 'Vous pouvez gérer ici les modèles des permissions des utilisateurs. Les modèles sont des permissions effectives, si vous modifiez un modèle les éléments auxquels ce modèle était assigné verront leurs permissions modifiées aussi.',
	...
	'ACP_VIEW_ADMIN_PERMISSIONS_EXPLAIN'		=> 'Vous pouvez consulter ici les permissions effectives des administrateurs assignées aux utilisateurs ou groupes sélectionnés',
	'ACP_VIEW_GLOBAL_MOD_PERMISSIONS_EXPLAIN'	=> 'Vous pouvez consulter ici les permissions effectives des modérateurs globaux assignées aux utilisateurs ou groupes sélectionnés',
	'ACP_VIEW_FORUM_PERMISSIONS_EXPLAIN'		=> 'Vous pouvez consulter ici les permissions effectives des forums assignées aux utilisateurs ou groupes sélectionnés',
	'ACP_VIEW_FORUM_MOD_PERMISSIONS_EXPLAIN'	=> 'Vous pouvez consulter ici les permissions effectives des modérateurs du forum assignées aux utilisateurs ou groupes sélectionnés',
	'ACP_VIEW_USER_PERMISSIONS_EXPLAIN'			=> 'Vous pouvez consulter ici les permissions effectives des utilisateurs assignées aux utilisateurs ou groupes sélectionnés',
	...
	'ALL_NEVER'					=> '<samp>JAMAIS</samp> pour tout',
	'ALL_NO'					=> '<samp>NON</samp> pour tout',
	'ALL_USERS'					=> 'Sélectionner tous les utilisateurs',
	'ALL_YES'					=> '<samp>OUI</samp> pour tout',
	...
	'NO_ROLE_ASSIGNED_EXPLAIN'	=> 'La configuration de ce modèle ne modifie pas les permissions sur la droite. Si vous souhaitez modifier/supprimer toutes les permissions, vous devez utiliser le lien “<samp>NON</samp> à tout”.',
