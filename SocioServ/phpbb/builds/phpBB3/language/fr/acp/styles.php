...
$lang = array_merge($lang, array(
	'ACP_IMAGESETS_EXPLAIN'	=> 'Un pack d\'images comprend tous les boutons, forums, répertoires, etc. et d\'autres images qui sont utilisées sur le forum. Ici, vous pouvez modifier, exporter ou supprimer les pack d\'images existants et en importer ou en activer de nouveaux.',
	'ACP_STYLES_EXPLAIN' => 'Ici, vous pouvez gérer les styles disponibles sur votre forum. Un style consiste en un template, un thème et un pack d\'images. Ici, vous pouvez modifier le style existant, supprimer, désactiver, réactiver, créer ou en importer de nouveaux. Vous pouvez également voir à quoi ressemblera le style, en utilisant la fonction aperçu. Le style par défaut est mis en évidence par un astérisque (*). Le nombre total d\'utilisateurs pour chaque style est également spécifié, notez que la fonction d\'annulation des styles utilisateurs ne figure pas ici.',
	'ACP_TEMPLATES_EXPLAIN' => 'Un template est une page HTML qui comprend toutes les balises utilisées pour gérer la mise en page de votre forum. Ici, vous pouvez éditer, supprimer, exporter, importer et prévisualiser l\'ensemble du template. Vous pouvez également modifier le code du template utilisé pour produire des BBCodes.',
	...
	'CONFIRM_IMAGESET_REFRESH' => 'Etes-vous sûr de vouloir rafraîchir toutes les données du pack d\'images? Les données chargées remplaceront toutes les modifications faites au pack d\'images réalisées avec l\'éditeur.',
	'CONFIRM_TEMPLATE_CLEAR_CACHE' => 'Etes-vous sûr de vouloir effacer toutes les versions en cache des fichiers de votre template?',
	'CONFIRM_TEMPLATE_REFRESH' => 'Etes-vous sûr de vouloir rafraîchir toutes les données du template dans la base de données, avec le contenu du système de fichiers? Cela remplacera toutes les modifications prises en charge avec l\'éditeur de modèle dont le modèle est stocké dans la base de données.',
	'CONFIRM_THEME_REFRESH' => 'Etes-vous sûr de vouloir rafraîchir les données du thème de la base avec les thèmes du système de fichiers? Cela remplacera toutes les modifications prises en charge avec l\'éditeur de thème dont le thème est stocké dans la base de données.',
	'COPYRIGHT' => 'Copyright',
	...
	'DELETE_FROM_FS' => 'Supprimer depuis le système de fichiers',
	'DELETE_IMAGESET' => 'Supprimer un pack d\'images',
	'DELETE_IMAGESET_EXPLAIN' => 'Vous pouvez supprimer de la base les packs d\'images choisis. De plus, si vous y êtes autorisé vous pouvez supprimer l\'ensemble du système de fichiers. Notez que l\'opération est irréversible donc le pack d\'images ne pourra pas être récupéré. Il est recommandé de l\'exporter au préalable pour une éventuelle utilisation future.',
	'DELETE_STYLE' => 'Supprimer un style',
	'DELETE_STYLE_EXPLAIN' => 'Vous pouvez supprimer le style choisi. Vous ne pouvez pas supprimer tous les éléments du style à partir d\'ici. Ils doivent être effacés individuellement via leurs pages respectives. Notez que cette opération est irréversible.',
	'DELETE_TEMPLATE' => 'Supprimer un template',
	'DELETE_TEMPLATE_EXPLAIN' => 'Vous pouvez supprimer un ensemble de templates de la base de données. De plus, si vous y êtes autorisé vous pouvez supprimer cet ensemble du système de fichiers. Notez que l\'opération est irréversible. Donc, les modèles sont supprimés définitivement. Il est vivement recommandé de l\'exporter au préalable pour une éventuelle utilisation future.',
	'DELETE_THEME' => 'Supprimer un thème',
	'DELETE_THEME_EXPLAIN' => 'Vous pouvez supprimer un thème de la base de données. De plus, si vous y êtes autorisé, vous pouvez supprimer le thème du système de fichiers. Notez que l\'opération est irréversible. Le thème est donc supprimé définitivement. Il est vivement recommandé de l\'exporter au préalable pour une éventuelle utilisation future.',
	'DETAILS' => 'Détails',
	...
	'EDIT_THEME_EXPLAIN' => 'Ici vous pouvez éditer le thème sélectionné, changer les couleurs, les images, etc. Vous pouvez basculer de l\'interface simplifiée où vous pouvez choisir des couleurs basiques, etc. à une interface avancée "raw CSS". Le mode raw vous permet de modifier des paramètres comme les bordures, etc. Ne changez que les paramètres que vous souhaitez modifier et laissez le reste vide ou indéfini.',
	...
	'INSTALL_IMAGESET_EXPLAIN' => 'Ici vous pouvez installer votre pack d\'images. Vous pouvez modifier certaines informations si vous le désirez ou utiliser les paramètres par défaut.',
	...
	'INSTALL_TEMPLATE_EXPLAIN' => 'Ici vous pouvez installer un nouveau template. Selon la configuration de votre serveur, vous aurez plus ou moins d\'options à votre disposition.',
	'INSTALL_THEME' => 'Installer un Theme',
	'INSTALL_THEME_EXPLAIN' => 'Ici vous pouvez installer votre thème. Vous pouvez modifier les éléments que vous souhaitez ou mettre les paramètres par défaut.',
	...
	'NO_CLASS' => 'Classe inexistante dans la feuille de style.',
	'NO_IMAGESET' => 'Pack d\'images inexistant.',
	'NO_IMAGE' => 'Aucune image.',
	'NO_IMAGE_ERROR' => 'Impossible de trouver les images sur le système.',
	...
	'ONLY_IMAGESET' => 'C\'est le seul pack d\'images installé, vous ne pouvez pas le supprimer.',
	'ONLY_STYLE' => 'C\'est le seul style installé, vous ne pouvez pas le supprimer.',
	'ONLY_TEMPLATE' => 'C\'est le seul template installé, vous ne pouvez pas le supprimer.',
	'ONLY_THEME' => 'C\'est le seul thème installé, vous ne pouvez pas le supprimer.',
	...
	'STYLE_DETAILS_UPDATED' => 'Style modifié avec succès.',
	...
	'STYLE_EXPORTED' => 'Style exporté avec succès et sauvegardé dans %s.',
	...
	'TEMPLATE_DETAILS_UPDATED' => 'Le template a été mis à jour avec succès.',
	...
	'TEMPLATE_EXPORTED' => 'Templates exportés avec succès et stockés dans %s.',
	'TEMPLATE_FILE' => 'Fichiers du template',
	'TEMPLATE_FILE_UPDATED' => 'Fichiers du template modifiés avec succès.',
	...
	'THEME_ADDED' => 'Nouveau thème ajouté avec succès.',
	'THEME_ADDED_DB' => 'Nouveau thème ajouté avec succès dans la base de données.',
	'THEME_CLASS_ADDED' => 'Classe personnalisée ajoutée avec succès.',
	'THEME_DELETED' => 'Thème supprimé avec succès.',
	'THEME_DELETED_FS' => 'Thème supprimé avec succès de la base de données mais des fichiers peuvent encore subsister sur le système.',
	'THEME_DETAILS_UPDATED' => 'Eléments du thème mis à jour avec succès.',
	...
	'THEME_UPDATED' => 'Classe mise à jour avec succès.',

	'UNDERLINE' => 'Souligné',
	'UNINSTALLED_IMAGESET' => 'Packs d\'images non installés',
	'UNINSTALLED_STYLE' => 'Styles non installés',
