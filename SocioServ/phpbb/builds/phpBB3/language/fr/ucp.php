...
$lang = array_merge($lang, array(
	...
	'ADD_FOES_EXPLAIN'   			=> 'Entrez un pseudo par ligne',
	'ADD_FOLDER'   					=> 'Nouveau dossier',
	'ADD_FRIENDS'   				=> 'Ajouter des amis',
	'ADD_FRIENDS_EXPLAIN'   		=> 'Entrez un pseudo par ligne.',
	...
	'EDIT_DRAFT_EXPLAIN'   		=> 'Ici, vous pouvez modifier votre brouillon. Les brouillons ne contiennent pas les fichiers joints et les sondages.',
	'EMAIL_BANNED_EMAIL'   		=> 'L\'adresse e-mail saisie est interdite.',
	'EMAIL_INVALID_EMAIL'   	=> 'L\'adresse e-mail saisie est invalide.',
	'EMAIL_REMIND'				=> 'Adresse e-mail associée à votre compte. Si vous ne l\'avez pas modifiée via votre panneau d\'utilisateur, c\'est l\'adresse que vous avez fournie lors de votre inscription.',
	...
	'NO_EMAIL_USER'  			=> 'L\'e-mail/pseudo fourni est introuvable.',
	...
	'REGISTRATION'   					=> 'Inscription',
   	'RELEASE_MESSAGES'   				=> '%sNettoyer les messages en attente%s… ils seront reclassés dans les dossiers adéquats si l\'espace nécessaire est disponible.',
	...
	'USERNAME_DISALLOWED_USERNAME'   		=> 'Le nom d\'utilisateur choisi a été banni.',
	...
	'WATCHED_EXPLAIN'   	=> 'Ici, vous pouvez afficher la liste des forums et sujets que vous surveillez. Vous serez informé des nouveaux messages écrits dans ceux-ci. Pour vous désabonner, cochez le forum ou le sujet et cliquez sur <em>Ne plus surveiller</em>.',
	...
	'GROUPS_EXPLAIN'   	=> 'Les groupes d\'utilisateurs permettent aux administrateurs de mieux gérer leurs utilisateurs. Par défaut vous serez placé dans un groupe spécifique, c\'est votre groupe par défaut. Ce groupe définit comment vous apparaissez sur le forum, par exemple la couleur de votre pseudo, votre avatar, rang, etc. Si l\'administrateur le permet, vous serez autorisé à changer votre groupe par défaut. Vous pouvez être placé ou rejoindre d\'autres groupes. Certains groupes peuvent vous donner des permissions supplémentaires de lecture ou vous donner accès à d\'autres fonctionnalités du forum.',
