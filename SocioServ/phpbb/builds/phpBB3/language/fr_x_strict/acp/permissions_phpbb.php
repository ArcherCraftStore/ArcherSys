...
/** 
* acp_permissions (phpBB Permission Set) [French]
*
* @package language
* @version $Id: permissions_phpbb.php,v 1.28 2007/07/19 20:37:52 acydburn Exp $
* @translation $Id: permissions_phpbb.php,v 0.28 2007/07/27 21:48:05 xaphos Exp $
...
$lang = array_merge($lang, array(
	...
	'acl_u_chgname'		=> array('lang' => 'Peut changer de nom d’utilisateur', 'cat' => 'profile'),
	'acl_u_chgpasswd'	=> array('lang' => 'Peut changer de mot de passe', 'cat' => 'profile'),
	'acl_u_chgemail'	=> array('lang' => 'Peut changer d’adresse e-mail', 'cat' => 'profile'),
	'acl_u_chgavatar'	=> array('lang' => 'Peut changer d’avatar', 'cat' => 'profile'),
	'acl_u_chggrp'		=> array('lang' => 'Peut changer de groupe d’utilisateurs par défaut', 'cat' => 'profile'),
	...
	'acl_u_masspm'		=> array('lang' => 'Peut envoyer des MP de masse aux utilisateurs et groupes', 'cat' => 'pm'),
	'acl_u_readpm'		=> array('lang' => 'Peut lire les messages privés', 'cat' => 'pm'),
	'acl_u_pm_edit'		=> array('lang' => 'Peut éditer ses messages privés', 'cat' => 'pm'),
	'acl_u_pm_delete'	=> array('lang' => 'Peut supprimer les messages privés de son dossier', 'cat' => 'pm'),
	'acl_u_pm_forward'	=> array('lang' => 'Peut transmettre des messages privés', 'cat' => 'pm'),
	'acl_u_pm_emailpm'	=> array('lang' => 'Peut s’envoyer par e-mail des messages privés', 'cat' => 'pm'),
	...
	'acl_u_pm_bbcode'	=> array('lang' => 'Peut publier du BBCode dans les messages privés', 'cat' => 'pm'),
	'acl_u_pm_smilies'	=> array('lang' => 'Peut publier des smileys dans les messages privés', 'cat' => 'pm'),
	'acl_u_pm_img'		=> array('lang' => 'Peut publier des images dans les messages privés', 'cat' => 'pm'),
	'acl_u_pm_flash'	=> array('lang' => 'Peut publier du Flash dans les messages privés', 'cat' => 'pm'),

	'acl_u_sendemail'	=> array('lang' => 'Peut envoyer des e-mail', 'cat' => 'misc'),
	...
	'acl_u_viewonline'	=> array('lang' => 'Peut voir les utilisateurs cachés en ligne', 'cat' => 'misc'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_read'		=> array('lang' => 'Peut lire les forums', 'cat' => 'post'),
	'acl_f_post'		=> array('lang' => 'Peut commencer de nouveaux sujets', 'cat' => 'post'),
	'acl_f_reply'		=> array('lang' => 'Peut répondre aux sujets', 'cat' => 'post'),
	'acl_f_icons'		=> array('lang' => 'Peut utiliser les icônes de sujets/messages', 'cat' => 'post'),
	'acl_f_announce'	=> array('lang' => 'Peut publier des annonces', 'cat' => 'post'),
	'acl_f_sticky'		=> array('lang' => 'Peut publier des posts-it', 'cat' => 'post'),
	...
	'acl_f_sigs'		=> array('lang' => 'Peut utiliser les signatures', 'cat' => 'content'),
	'acl_f_bbcode'		=> array('lang' => 'Peut publier du BBCode', 'cat' => 'content'),
	'acl_f_smilies'		=> array('lang' => 'Peut publier des smileys', 'cat' => 'content'),
	'acl_f_img'			=> array('lang' => 'Peut publier des images', 'cat' => 'content'),
	'acl_f_flash'		=> array('lang' => 'Peut publier du Flash', 'cat' => 'content'),
	...
	'acl_f_subscribe'	=> array('lang' => 'Peut souscrire à un forum', 'cat' => 'actions'),
	'acl_f_print'		=> array('lang' => 'Peut imprimer des sujets', 'cat' => 'actions'),
	'acl_f_email'		=> array('lang' => 'Peut envoyer par e-mail des sujets', 'cat' => 'actions'),

	'acl_f_search'		=> array('lang' => 'Peut rechercher le forum', 'cat' => 'misc'),
	'acl_f_ignoreflood' => array('lang' => 'Peut ignorer la limite de flood', 'cat' => 'misc'),
	'acl_f_postcount'	=> array('lang' => 'Peut augmenter le compteur de messages<br /><em>Veuillez noter que ce réglage n’affecte que les nouveaux messages.</em>', 'cat' => 'misc'),
	'acl_f_noapprove'	=> array('lang' => 'Peut publier sans approbation', 'cat' => 'misc'),
));
...
$lang = array_merge($lang, array(
	...
	'acl_m_warn'	=> array('lang' => 'Peut donner des avertissements<br /><em>Ce réglage n’est assigné que globalement. Ce n’est pas basé au forum.</em>', 'cat' => 'misc'), // This moderator setting is only global (and not local)
...
$lang = array_merge($lang, array(
	...
	'acl_a_server'		=> array('lang' => 'Peut modifier les réglages du serveur/communication', 'cat' => 'settings'),
	...
	'acl_a_icons'		=> array('lang' => 'Peut modifier les icônes de sujets/messages et les smileys', 'cat' => 'posting'),
	'acl_a_words'		=> array('lang' => 'Peut modifier la censure de mots', 'cat' => 'posting'),
	'acl_a_bbcode'		=> array('lang' => 'Peut définir des balises BBCode', 'cat' => 'posting'),
	...
	'acl_a_userdel'		=> array('lang' => 'Peut supprimer/délester des utilisateurs', 'cat' => 'user_group'),
	...
	'acl_a_authgroups'	=> array('lang' => 'Peut modifier les permissions de groupes indivuels', 'cat' => 'permissions'),
	...
	'acl_a_aauth'		=> array('lang' => 'Peut modifier les permissions d’administrateurs', 'cat' => 'permissions'),
	'acl_a_uauth'		=> array('lang' => 'Peut modifier les permissions d’utilisateurs', 'cat' => 'permissions'),
	...
	'acl_a_language'	=> array('lang' => 'Peut gérer les packs de langues', 'cat' => 'misc'),
	...
	'acl_a_backup'		=> array('lang' => 'Peut sauvegarder/restaurer la base de données', 'cat' => 'misc'),
	'acl_a_search'		=> array('lang' => 'Peut gérer les programmes de gestion de l’indexage et les réglages', 'cat' => 'misc'),
));
