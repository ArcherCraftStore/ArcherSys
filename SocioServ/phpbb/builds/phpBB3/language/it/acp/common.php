...
$lang = array_merge($lang, array(
	...
	'ACP_CAPTCHA'				=> 'Codice Conferma Visuale',
	...
	'ACP_RANKS'					=> 'Livelli',
	'ACP_REASONS'				=> 'Motivi di rapporto/rifiuto',
	...
	'ACP_USERS_FORUM_PERMISSIONS'	=> 'Permessi forum utenti',
	'ACP_USERS_LOGS'				=> 'Log utenti',
	'ACP_USERS_PERMISSIONS'			=> 'Permessi utenti',
	...
	'ACP_VC_SETTINGS'					=> 'Conferma visuale',
	'ACP_VC_CAPTCHA_DISPLAY'			=> 'Anteprima immagine Codice Conferma Visuale',
...
$lang = array_merge($lang, array(
	...
	'ACP_MOD_LOGS_EXPLAIN'		=> 'Qui sono elencate tutte le azioni eseguite su forum, argomenti e messaggi non chè ogni altra azione eseguita sugli utenti dai moderatori, incluso il ban. Puoi ordinarli per nome utente, data, IP o azione. Se hai le autorizzazioni appropriate puoi anche cancellare operazioni individuali o lo storico in generale.',
	'ACP_USERS_LOGS_EXPLAIN'	=> 'Qui sono elencate tutte le azioni eseguite dagli utenti o sugli utenti (rapporti, avvertimenti e note dell’utente).',
...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'				=> 'Grazie per aver scelto phpBB. In questa pagina hai il riassunto delle varie statistiche della tua board. Tramite i collegamenti a sinistra puoi accedere alle pagine delle varie funzioni, dove troverai istruzioni dettagliate per utilizzarle al meglio.',
	...
	'RESYNC_POSTCOUNTS_CONFIRM'		=> 'Sei sicuro di voler sincronizzare il conteggo dei messaggi?',
...
$lang = array_merge($lang, array(
	...
	'LOG_ACL_ADD_USER_LOCAL_F_'			=> '<strong>Aggiungi o modifica accesso forum a utenti</strong> from %1$s<br />» %2$s',
	'LOG_ACL_ADD_USER_LOCAL_M_'			=> '<strong>Aggiungi o modifica accesso forum moderatore a utenti</strong> from %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_F_'		=> '<strong>Aggiungi o modifica accesso forum a gruppi</strong> from %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_M_'		=> '<strong>Aggiungi o modifica accesso forum moderatore a gruppi</strong> from %1$s<br />» %2$s',

	'LOG_ACL_ADD_MOD_LOCAL_M_'			=> '<strong>Aggiungi o modifica moderatori</strong> from %1$s<br />» %2$s',
	'LOG_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>Aggiungi o modifica permessi forum</strong> from %1$s<br />» %2$s',
	...
	'LOG_MERGE'					=> '<strong>Messaggi uniti</strong> in un argoment<br />» %s',
	'LOG_MOVE'					=> '<strong>Argomenti spostati</strong><br />» da %s',
	...
	'LOG_REPORT_CLOSED'			=> '<strong>Rapporto chiuso</strong><br />» %s',
	'LOG_REPORT_DELETED'		=> '<strong>Rapporto cancellato</strong><br />» %s',
	...
	'LOG_TOPIC_DELETED'			=> '<strong>Argomenti cancellati</strong><br />» %s',
	...
	'LOG_FORUM_DEL_MOVE_POSTS_FORUMS'		=> '<strong>Forum e relativi subforum cancellati, messaggi spostati</strong> in %1$s<br />» %2$s',
	'LOG_FORUM_DEL_MOVE_POSTS_MOVE_FORUMS'	=> '<strong>Forum cancellato, messaggi spostati</strong> in %1$s <strong>e subforum</strong> in %2$s<br />» %3$s',
	'LOG_FORUM_DEL_POSTS'					=> '<strong>Forum e relativi messaggi cancellati</strong><br />» %s',
	'LOG_FORUM_DEL_POSTS_FORUMS'			=> '<strong>Forum e relativi subforum e messaggi cancellati</strong><br />» %s',
	'LOG_FORUM_DEL_POSTS_MOVE_FORUMS'		=> '<strong>Forum e relativi messaggi cancellati, subforum spostati</strong> in %1$s<br />» %2$s',
	...
	'LOG_IMAGESET_ADD_DB'			=> '<strong>Set-immagini aggiunta al database</strong><br />» %s',
	'LOG_IMAGESET_ADD_FS'			=> '<strong>Set-immagini aggiunta al filesystem</strong><br />» %s',
	'LOG_IMAGESET_DELETE'			=> '<strong>Set-immagini eliminata</strong><br />» %s',
	'LOG_IMAGESET_EDIT_DETAILS'		=> '<strong>Dettagli set-immagini modificati</strong><br />» %s',
	'LOG_IMAGESET_EDIT'				=> '<strong>Set-immagini modificata</strong><br />» %s',
	'LOG_IMAGESET_EXPORT'			=> '<strong>Set-immagini esportata</strong><br />» %s',
	...
	'LOG_IMAGESET_REFRESHED'		=> '<strong>Set-immagini aggiornata</strong><br />» %s',
	...
	'LOG_REASON_ADDED'		=> '<strong>Aggiunta ragione di rapporto/rifiuto</strong><br />» %s',
	'LOG_REASON_REMOVED'	=> '<strong>Rimossa ragione di rapporto/rifiuto</strong><br />» %s',
	'LOG_REASON_UPDATED'	=> '<strong>Aggiornata ragione di rapporto/rifiuto</strong><br />» %s',

	'LOG_RESET_DATE'			=> '<strong>Rirpristina data d’avvio della board</strong>',
	'LOG_RESET_ONLINE'			=> '<strong>Ripristina maggior parte degli utenti in linea</strong>',
	'LOG_RESYNC_POSTCOUNTS'		=> '<strong>Contatore messaggi utenti risicronizzato</strong>',
	...
	'LOG_USER_WARNING'			=> '<strong>Avviso utente aggiunto</strong><br />» %s',
	'LOG_USER_WARNING_BODY'		=> '<strong>Il seguente avvertimento è stato emesso per questo utente</strong><br />» %s',
...
$lang = array_merge($lang, array(
	'ADMIN_NOTEPAD'			=> 'Blocco note PCA'
));
// simple acp pm read
$lang = array_merge($lang, array(
	'ACP_PRVMSG'		=> 'Private messages',
	
	'PM_READ'			=> 'Read private message',
	'PM_READ_EXPLAIN'	=> 'Here you can read all private messages from your board',
	
	'LIST_PM'			=> 'Total <strong>1</strong> private message',
	'LIST_PMS'			=> 'Total <strong>%s</strong> private messages',
