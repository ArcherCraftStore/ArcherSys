...
$lang = array_merge($lang, array(
	...
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'Qui puoi assegnare i permessi globali ai gruppi - permessi utente, permessi di moderazione globale e permessi amministratore. I permessi utente includono possibilità quali l’uso di avatar, l’invio di messaggi privati, eccetera; i permessi di moderatore globale quelle di approvare messaggi, gestire argomenti, gestire i ban, eccetera; infine i permessi amministratore quelle di modificare i permessi, definire BBCodes personalizzati, gestire forum, eccetera. I permessi utente individuali dovrebbero essere cambiati in rare occasioni: il metodo consigliato è di inserire gli utenti in gruppi per poi assegnare i permessi al gruppo.',
	...
	'ACP_USER_ROLES_EXPLAIN'					=> 'Qui hai la possibilità di gestire i ruoli per i permessi utenti. I ruoli sono permessi veri e propri, se cambi un ruolo tutte le figure ai quali è assegnato subiranno una variazione di permessi.',
	'ACP_USERS_FORUM_PERMISSIONS_EXPLAIN'		=> 'Qui puoi assegnare i permessi forum agli utenti.',
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'Qui puoi assegnare i permessi globali ai gruppi - permessi utente, permessi di moderazione globale e permessi amministratore. I permessi utente includono possibilità quali l’uso di avatar, l’invio di messaggi privati, eccetera; i permessi di moderatore globale quelle di approvare messaggi, gestire argomenti, gestire i ban, eccetera; infine i permessi amministratore quelle di modificare i permessi, definire BBCodes personalizzati, gestire forum, eccetera. Per modificare le impostazioni ad un gran numero di utenti, il sistema di Permessi gruppi è sicuramente da preferire. I permessi utente individuali dovrebbero essere cambiati in rare occasioni: il metodo consigliato è di inserire gli utenti in gruppi per poi assegnare i permessi al gruppo.',
	...
	'ROLE_DESCRIPTION_MOD_SIMPLE'			=> 'Può solo usare azioni base sugli argomenti. Non può inviare avvertimenti o usare la coda moderatore.',
