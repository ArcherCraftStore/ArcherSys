<?php
/**
* acp_permissions (phpBB Permission Set) [Italian]
*
* @package language
...
$lang = array_merge($lang, array(
	...
	'acl_u_masspm'		=> array('lang' => 'Può inviare mp multipli e ai gruppi', 'cat' => 'pm'),
	...
	'acl_u_pm_delete'	=> array('lang' => 'Può rimuovere i messaggi privati dalla cartella', 'cat' => 'pm'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_reply'		=> array('lang' => 'Può rispondere argomenti', 'cat' => 'post'),
	...
	'acl_f_flash'		=> array('lang' => 'Può puoi inserire file flash', 'cat' => 'content'),
	...
	'acl_f_report'		=> array('lang' => 'Può fare rapporto messaggi', 'cat' => 'actions'),
...
$lang = array_merge($lang, array(
	...
	'acl_m_report'		=> array('lang' => 'Può chiudere e cancellare rapporti', 'cat' => 'post_actions'),
	...
	'acl_m_warn'	=> array('lang' => 'Può emettere avvertimenti<br /><em>Questa impostazione esiste solo come globale e non localmente su forum.</em>', 'cat' => 'misc'), // This moderator setting is only global (and not local)
...
$lang = array_merge($lang, array(
	...
	'acl_a_authusers'	=> array('lang' => 'Può modificare permessi utenti individuali', 'cat' => 'permissions'),
	...
	'acl_a_backup'		=> array('lang' => 'Può fare backup e fare restore database', 'cat' => 'misc'),
