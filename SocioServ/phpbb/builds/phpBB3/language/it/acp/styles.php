...
$lang = array_merge($lang, array(
	...
	'BACKGROUND_IMAGE'		=> 'Immgine di sfondo',
	...
	'CONFIRM_TEMPLATE_REFRESH'		=> 'Sei sicuro di voler aggiornare i dati del template in database coi contenuti del template su file? Saranno cancellate tutte le modifiche effettuate con l’editor dei modelli.',
	'CONFIRM_THEME_REFRESH'			=> 'Sei sicuro di voler aggiornare i dati del tema in database coi contenuti del tema su file? Saranno cancellate tutte le modifiche effettuate con l’editor dei temi.',
	'COPYRIGHT'						=> 'Copyright',
	...
	'DELETE_FROM_FS'			=> 'Cancella dal filesystem',
	'DELETE_IMAGESET'			=> 'Cancella set-immagini',
	'DELETE_IMAGESET_EXPLAIN'	=> 'Qui puoi eliminare un determinato set-imagini dal database. Se hai i permessi necessari, è anche possibile cancellare il set-immagini dal file di configurazione. Attenzione: non esiste la possibilità di tornare indietro! La cancellazione di un set-immagini è definitiva. Si raccomanda di eseguire un export prima di cancellarlo, per possibile uso futuro di queste immagini.',
	'DELETE_STYLE'				=> 'Cancella stile',
	'DELETE_STYLE_EXPLAIN'		=> 'Qui puoi cancellare lo stile selezionato. Da qui non puoi eliminare tutti gli elementi di uno stile. GLi elementi devono essere individualmente scelti nei rispettivi campi. Attenzione a cancellare gli stili, perché non esiste la possibilità di tornare indietro.',
	'DELETE_TEMPLATE'			=> 'Cancella template',
	'DELETE_TEMPLATE_EXPLAIN'	=> 'Qui puoi cancellare dal database un template. Se hai i permessi necessari, è anche possibile cancellare il set dal file di configurazione. Attenzione: non esiste la possibilità di tornare indietro! La cancellazione dei modelli è definitiva. Si raccomanda di eseguire un export prima di cancellarlo, per possibile uso futuro di questo template.',
	'DELETE_THEME'				=> 'Cancella tema',
	'DELETE_THEME_EXPLAIN'		=> 'Qui puoi cancellare dal database il tema selezionato. Se hai i permessi necessari, è anche possibile cancellare il tema dal file di configurazione. Attenzione: non esiste la possibilità di tornare indietro! La cancellazione dei temi è definitiva. Si raccomanda di eseguire un export prima di cancellarlo, per possibile uso futuro di questo tema.',
	'DETAILS'					=> 'Dettagli',
	...
	'EDIT_DETAILS_TEMPLATE_EXPLAIN'		=> 'Qui si modificano alcune caratteristiche del template, per esempio il nome. Puoi cambiare la definizione degli stili dal file di configurazione al database e vice versa. Possibilità che dipende dalla configurazione PHP del server e se il web server ha il permesso di scrivere i file.',
	...
	'EDIT_IMAGESET_EXPLAIN'				=> 'Qui si modificano le singole immagini che compongono il set-immagini. Per ogni immagine Puoi definirne le dimensioni, ma tuttavia è opzionale. Dichiarare la dimensione potrebbe essere utile per evitare comportamenti imprevedibili da parte di alcuni browser. Si tenga presente che se non si specificando le dimensioni dell’immagine il database si alleggerisce.',
	'EDIT_TEMPLATE'						=> 'Modifica template',
	'EDIT_TEMPLATE_EXPLAIN'				=> 'Qui puoi modificare direttamente il set di modelli. Attenzione: queste modifiche, una volta fatte, sono permanenti e non si può più tornare indietro. Se PHP è in grado di scrivere sulla cartella degli stili, i cambiamenti fatti saranno scritti direttamente su file. Se PHP non ha i permessi di scrittura su file di sistema, le modifiche saranno copiate nel database e i cambiamenti saranno effettuati solo lì. Attenzione a modificare il set di modelli, tutte le variabili di rimpiazzo devono essere chiuse tra graffe {XXXX} come anche le istruzioni condizionali.',
	'EDIT_TEMPLATE_STORED_DB'			=> 'Impossibile scrivere su server il file template e quindi salvare i modelli, verrà salvato nel database con le modifiche.',
	...
	'IMG_FORUM_UNREAD'			=> 'Forum nuovi messaggi',
	'IMG_FORUM_UNREAD_LOCKED'	=> 'Forum nuovi messaggi bloccati',
	'IMG_FORUM_UNREAD_SUBFORUM'	=> 'Subforum nuovi messaggi',
	'IMG_SUBFORUM_READ'			=> 'Legenda subforum',
	'IMG_SUBFORUM_UNREAD'		=> 'Legenda subforum nuovi messaggi',
	
	'IMG_TOPIC_MOVED'			=> 'Argomento spostato',

	'IMG_TOPIC_READ'				=> 'Argomento',
	'IMG_TOPIC_READ_MINE'			=> 'Argomento dove ho scritto',
	'IMG_TOPIC_READ_HOT'			=> 'Argomento popolare',
	'IMG_TOPIC_READ_HOT_MINE'		=> 'Argomento dove ho scritto popolare',
	'IMG_TOPIC_READ_LOCKED'			=> 'Argomento bloccato',
	'IMG_TOPIC_READ_LOCKED_MINE'	=> 'Argomento dove ho scritto bloccato',

	'IMG_TOPIC_UNREAD'				=> 'Argomento con nuovi',
	'IMG_TOPIC_UNREAD_MINE'			=> 'Argomento dove ho scritto con nuovi',
	'IMG_TOPIC_UNREAD_HOT'			=> 'Argomento popolare con nuovi',
	'IMG_TOPIC_UNREAD_HOT_MINE'		=> 'Argomento dove ho scritto popolare con nuovi',
	'IMG_TOPIC_UNREAD_LOCKED'		=> 'Argomento bloccato con nuovi',
	'IMG_TOPIC_UNREAD_LOCKED_MINE'	=> 'Argomento dove ho scritto bloccato con nuovi',

	'IMG_STICKY_READ'				=> 'Argomento importante',
	'IMG_STICKY_READ_MINE'			=> 'Argomento importante dove ho scritto',
	'IMG_STICKY_READ_LOCKED'		=> 'Argomento importante bloccato',
	'IMG_STICKY_READ_LOCKED_MINE'	=> 'Argomento importante dove ho scritto bloccato',
	'IMG_STICKY_UNREAD'				=> 'Argomento importante con nuovi',
	'IMG_STICKY_UNREAD_MINE'		=> 'Argomento importante dove ho scritto con nuovi',
	'IMG_STICKY_UNREAD_LOCKED'		=> 'Argomento importante bloccato con nuovi',
	'IMG_STICKY_UNREAD_LOCKED_MINE'	=> 'Argomento importante dove ho scritto bloccato con nuovi',

	'IMG_ANNOUNCE_READ'					=> 'Annuncio',
	'IMG_ANNOUNCE_READ_MINE'			=> 'Annuncio dove ho scritto',
	'IMG_ANNOUNCE_READ_LOCKED'			=> 'Annuncio bloccato',
	'IMG_ANNOUNCE_READ_LOCKED_MINE'		=> 'Annuncio dove ho scritto bloccato',
	'IMG_ANNOUNCE_UNREAD'				=> 'Annuncio con nuovi',
	'IMG_ANNOUNCE_UNREAD_MINE'			=> 'Annuncio dove ho scritto con nuovi',
	'IMG_ANNOUNCE_UNREAD_LOCKED'		=> 'Annuncio bloccato con nuovi',
	'IMG_ANNOUNCE_UNREAD_LOCKED_MINE'	=> 'Annuncio dove ho scritto bloccato con nuovi',

	'IMG_GLOBAL_READ'					=> 'Annuncio globale',
	'IMG_GLOBAL_READ_MINE'				=> 'Annuncio globale dove ho scritto',
	'IMG_GLOBAL_READ_LOCKED'			=> 'Annuncio globale bloccato',
	'IMG_GLOBAL_READ_LOCKED_MINE'		=> 'Annuncio globale dove ho scritto bloccato',
	'IMG_GLOBAL_UNREAD'					=> 'Annuncio globale con nuovi',
	'IMG_GLOBAL_UNREAD_MINE'			=> 'Annuncio globale dove ho scritto con nuovi',
	'IMG_GLOBAL_UNREAD_LOCKED'			=> 'Annuncio globale bloccato con nuovi',
	'IMG_GLOBAL_UNREAD_LOCKED_MINE'		=> 'Annuncio globale dove ho scritto bloccato con nuovi',

	'IMG_PM_READ'		=> 'Messaggio privato letto',
	'IMG_PM_UNREAD'		=> 'Messagio privato non letto',
	...
	'IMG_ICON_POST_REPORT'			=> 'Fai rapporto al messaggio',
	...
	'IMG_ICON_TOPIC_REPORTED'		=> 'Messaggio con rapporto',
	...
	'NO_IMAGESET'				=> 'Non trovo il set-immagini nel filesystem.',
	'NO_IMAGE'					=> 'Nessuna immagine',
	'NO_IMAGE_ERROR'			=> 'Non trovo l’immagine nel filesystem.',
	'NO_STYLE'					=> 'Non trovo lo stile nel filesystem.',
	'NO_TEMPLATE'				=> 'Non trovo il template nel filesystem.',
	'NO_THEME'					=> 'Non trovo il tema nel filesystem.',
	...
	'TEMPLATE_ADDED'			=> 'Aggiunto modello e salvato su filesystem.',
	...
	'TEMPLATE_DELETED_FS'		=> 'Il set di template è stato cancellato dal database, ma nei file potrebbero essere rimaste alcune parti.',
	'TEMPLATE_DETAILS_UPDATED'	=> 'Dettagli modello aggiornati.',
	'TEMPLATE_EDITOR'			=> 'Modifica modello HTML',
	'TEMPLATE_EDITOR_HEIGHT'	=> 'Altezza editor template',
	'TEMPLATE_ERR_ARCHIVE'		=> 'Scegli un metodo di archivazione.',
	...
	'TEMPLATE_ERR_NOT_TEMPLATE'	=> 'L’archivio specificato non contiene un valido set-template.',
	...
	'TEMPLATE_LOCATION_EXPLAIN'	=> 'Le immagini sono sempre salvate su file.',
	...
	'THEME_LOCATION_EXPLAIN'	=> 'Le immagini sono sempre salvate su file.',
