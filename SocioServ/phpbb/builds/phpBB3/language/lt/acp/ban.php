...
$lang = array_merge($lang, array(
	...
	'30_MINS'	=> '30 minučių',
	'6_HOURS'	=> '6 valandos',
	'ACP_BAN_EXPLAIN'	=> 'Čia galite blokuoti vartotojus pagal vardus, IP adresus ar el. pašto adresą. Tokiu būdu galite neleisti vartotojui prieiti prie bet kurios diskusijų dalies. Jeigu pageidaujate, galite įrašyti trumpą (maksimaliai 3000 simbolių) blokavimo priežastį. Ji bus įrašyta į administratorių veiksmų registrą. Taip pat galite nurodyti blokavimo ilgumą. Pasirinkę <span style="text-decoration: underline;">Ikil -&gt;</span> ir įrašę datą <kbd>YYYY-MM-DD</kbd> formatu, galite netgi nurodyti datą, kada turi baigtis blokavimo periodas.',
	...
	'IP_BAN_EXPLAIN'	=> 'Norėdami įrašyti daugiau nei vieną IP adresą, kiekvieną jų rašykite naujoje eilutėje. Norėdami nurodyti IP adresų intervalą atskirkitę juos brūkšneliu (-). Dalinėms reikšmėms aprašyti naudokite “*”.',
	...
	'USER_UNBAN_EXPLAIN'	=> 'Jūs galite atblokuoti (arba ištrinti išskirtus) keletą vatotojų vardų vienu metu. Tai galite padaryti pasinaudoję klaviatūra ar pele ir surinkę teisingą kombinaciją jūsų kompiuteriui ir naršyklei. Išskirti vartotojų vardai yra paryškinti.',
));
