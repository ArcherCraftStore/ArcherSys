...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'Čia galite valdyti visus modulius. Atsiminkite, kad administratoriaus valdymo pultas turi trijų lygių meniu struktūrą (Kategorija -> Kategorija -> Modulis), kai kiti valdymo meniu turi dviejų lygių meniu struktūrą (Kategorija -> Modulis). Tokia struktūra turi būti išlaikyta. Taip pat būkite atsargūs ir neužrakinkite patys saves, jeigu išjungsite ar ištrinsite modulius atsakingus už modulių valdymą.',
	...
	'MODULE_DISPLAYED_EXPLAIN'	=> 'Jeigu nenorite rodyti šio modulio, bet vistiek norite jį naudoti, išjunkite šį nustatymą.',
