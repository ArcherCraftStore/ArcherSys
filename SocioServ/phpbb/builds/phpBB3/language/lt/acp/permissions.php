...
$lang = array_merge($lang, array(
	...
	'ACL_VIEW_EXPLAIN'	=> 'Čia galite matyti kaip vykdomos nustatytos vartotojo/grupės teisės. Raudonas kvadratas pažymi, kad vartotojas/grupė neturi tokios teisės, o žalias kvadrastas - kad vartotojas/grupė turi tokią teisę.',
	'ACL_YES'	=> 'Taip',
	...
	'ROLE_FORUM_ONQUEUE'	=> 'Moderavimo teilė',
	...
	'SET_USERS_FORUM_PERMISSIONS'	=> 'Nustatyti vartotojų forumo teises',
	'TRACE_DEFAULT'	=> 'Stadartiškai kiekvienos teisės reikšmė yra <samp>NE</samp> (nenustatyta). Tokiu būdu teisę galima pakeisti iš kitų lygių.',
	'TRACE_FOR'	=> 'Tiriama',
	...
	'TRACE_GROUP_NEVER_TOTAL_NO'	=> 'Grupės teisės reikšmė yra <samp>NIEKADA</samp> ir tampa naujaja sumine reikšme, kadangi ji dar nebuvo nustatyta (t.y. jos reikšmė buvo <samp>NE</samp>).',
	'TRACE_GROUP_NEVER_TOTAL_NO_LOCAL'	=> 'Grupės teisės reikšmė šiame forume yra <samp>NIEKADA</samp> ir tampa naujaja sumine reikšme, kadangi ji dar nebuvo nustatyta (t.y. jos reikšmė buvo <samp>NE</samp>).',
	...
	'TRACE_GROUP_YES_TOTAL_NO'	=> 'Grupės teisės reikšmė yra <samp>TAIP</samp> ir tampa naujaja sumine reikšme, kadangi ji dar nebuvo nustatyta (t.y. jos reikšmė buvo <samp>NE</samp>).',
	'TRACE_GROUP_YES_TOTAL_NO_LOCAL'	=> 'Grupės teisės reikšmė šiame forume yra <samp>TAIP</samp> ir tampa naujaja sumine reikšme, kadangi ji dar nebuvo nustatyta (t.y. jos reikšmė buvo <samp>NE</samp>).',
	...
	'TRACE_USER_FOUNDER'	=> 'Vartotojas yra steigėjas, todėl visos administravimo teisių reikšmės standartiškai yra <samp>TAIP</samp>.',
	...
	'TRACE_USER_NEVER_TOTAL_NO'	=> 'Vartotojo teisės reikšmė yra <samp>NIEKADA</samp> ir tampa naujaja sumine reikšme, kadangi ji buvo nustatyta į NE.',
	'TRACE_USER_NEVER_TOTAL_NO_LOCAL'	=> 'Vartotojo teisės reikšmė šiame forume yra <samp>NIEKADA</samp> ir tampa naujaja sumine reikšme, kadangi ji buvo nustatyta į NE.',
	...
	'TRACE_USER_YES_TOTAL_NO'	=> 'Vartotojo teisės reikšmė yra <samp>TAIP</samp> ir tampa naujaja sumine reikšme, kadangi ji buvo nustatyta į <samp>NE</samp>.',
	'TRACE_USER_YES_TOTAL_NO_LOCAL'	=> 'Vartotojo teisės reikšmė šiame forume yra <samp>TAIP</samp> ir tampa naujaja sumine reikšme, kadangi ji buvo nustatyta į <samp>NE</samp>.',
