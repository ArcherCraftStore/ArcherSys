...
$help = array(
	...
	array(
		0	=> 'Pakeičiau laiko juostas, tačiau laikas vistiek neteisingas!',
	...
	array(
		0	=> 'Kaip įsidėti paveikslėlį po savo vartotojo vardu?',
		1	=> 'Iš viso gali būti du paveikslėliai šalia vartotojo vardo. Priklausomai nuo stiliaus, kurį naudojate, pirmasis paveikslėlis yra susijęs su jūsų rangu. Dažniausiai tai būna žvaigždučių arba taškelių eilutė, kuri parodo kiek žinučių jūs esat parašę arba kokį statusą turite diskusijose. Antrasis dažniausiai didesnis paveikslėlis yra avataras. Dažniausiai jis būna unikalus. Avatarų galimybę ir būdą, kuriuo jie yra įkeliami, valdo diskusijų administratorius. Jeigu negalite jų naudoti, susisiekite su juo ir paklauskite kodėl avatarai buvo išjungti.',
	),
	array(
	...
	array(
		0	=> 'Kai paspaudžiu ant kurio nors vartotojo elektroninio pašto adreso, manes paprašo prisijungti. Kodėl?',
	...
	array(
		...
		1	=> 'Kai pradedate naują temą (arba redaguojate naujos temos pirmąją žinutę), apačioje turėtumėte matyti kortelę “Apklausos kūrimas”. Jeigu jos nematote, vadinasi neturite teisių kurti apklausas. Iš pradžių įrašykite apklausos pavadinimą, toliau įrašykite bent du punktus, už kuriuos balsuos apklausos dalyviai (kiekvieną punktą reikia rašyti naujoje eilutėje). Taip pat, pasinaudoję parametru “Options per user”, galite nurodyti, kiek punktų galės pasirinkti vartotojas apklausos metu, dienų skaičių, kiek tęsis apklausa (0 reiškia niekada nesibaigiančią apklausą) ir galiausiai galite nurodyti ar vartotojai galės atšaukti savo balsą ir dalyvauti apklausoje iš naujo.',
	),
	array(
		0	=> 'Kodėl negaliu pridėti daugiau apklausos punktų?',
		1	=> 'Punktų limitą nustato diskusijų administratorius. Susisiekite su juo, jeigu manote, kad jums reikia daugiau punktų nei leidžiama.',
	),
	array(
		0	=> 'Kaip regaduoti arba ištrinti apklausą?',
		1	=> 'Kaip ir pranešimus, apklausą gali redaguoti tik tas, kuris ją sukūrė, moderatoriai arba administratoriai. Norėdami redaguoti apklausą paspauskite redagavimo mygtuką šalia pirmo temos pranešimo. Ištrinti apklausą arba keisti apklausos punktų skaičių galima tik tada, kol niekas nebalsavo. Priešingu atveju ištrinti arba redaguoti apklausą gali tik moderatoriai arba administratoriai. Tai saugo apklausą nuo nesąžiningo apklausos punktų keitimo jai bevykstant.',
	),
	array(
	...
	array(
		...
		1	=> 'Kiekvienas diskusijų administratorius savo puslapyje turi savo taisyklių sąrašą. Jeigu sulaužysite nors vieną iš jų, galite gauti perspėjimą. Atsiminkite, kad tai diskusijų administratoriaus sprendimas ir phpBB Grupė neturi nieko bendro su dalinamais perspėjimais šiame puslapyje. Jeigu nesate tikras, kodėl gavote perspėjimą, susisiekite su diskusijų administratoriumi.',
	),
	array(
	...
	array(
		...
		1	=> 'Ne. Rašysi HTML kodos šioje diskusijų lentoje negalima. Daugelį teksto formavimo būdų, kuris pasiekiamas su HTML, galima įgyvendinti BBKodo pagalba.',
	),
	array(
	...
	array(
		...
		1	=> 'Temų piktogramos yra autoriaus pasirinktas paveikslėlis, kuris apibūdina temos turinį. Galimybę naudoti temų piktogramas nustato diskusijų admistratorius.',
	),
	array(
		0	=> '--',
	...
	array(
		...
		1	=> 'Jūsų paieška greičiausiai buvo neaiški, nes joje buvo per daug dažnai naudojamų žodžių, kurie phpBB3 neindeksuoja. Susiaurinkite paiešką ir naudokitės paieškos parametrai pasiekiamais per išplėstinės paieškos puslapį.',
	),
	array(
	...
	array(
		...
		1	=> 'Savo paties pranešimus galite rasti paspaudę ant “Ieškoti vartotojo pranešimų” vartotojo valdymo pulte arba jūsų aprašymo puslapyje. Norėdami surasti savo temas, pasinaudokite išplėstine paieška ir nurodykite temos autorių.',
	),
	array(
		0	=> '--',
