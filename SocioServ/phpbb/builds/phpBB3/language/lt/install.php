...
$lang = array_merge($lang, array(
	...
	'CLEAN_VERIFY'	=> 'Valoma ir tikrinama galutinė stuktūra',
	...
	'CONTINUE_OLD_CONVERSION'	=> 'Tęsti ankstesnį meginimą kovertuoti',
	'CONVERT'	=> 'Konvertuoti',
	...
	'CONV_ERROR_GET_CONFIG'	=> 'Nepavyko perskaityti diskusijų lentos konfigūracinio failo.',
	...
	'COULD_NOT_FIND_PATH'	=> 'Nepavyko aptikti senosios diskusijų lentos. Patikrinkite visus nustatymus ir pabandykite dar kartą.<br />» Jūsų nurodytas kelias %s.',
	...
	'DLL_MBSTRING'	=> 'Diaugiabaičių simbolių palaikymas',
	...
	'FINAL_STEP'	=> 'Vykdomas paskutinis etapas',
	...
	'FOUND'	=> 'Surasta',
	'FTP_CONFIG'	=> 'Konfigūracinio failo įkėlimas per FTP',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '		<p>Jūs sėkmingai įdiegėte phpBB %1$s. Dabar turite keletą pasirinkimų ką daryti toliau:</p>
		...
		<p>Paspaudę mygtuką apačioje pateksite į administratoriaus valdymo pultą. Nepagailėkite laiko ir peržiūrėkite visus esamus nustatymus. Atsiminkite, kad pagalbą galite rasti <a href="http://www.phpbb.com/support/documentation/3.0/">dokumentacijos puslapyje</a> ir <a href="http://www.phpbb.com/community/viewforum.php?f=46">palaikymo forumuose</a>. Taip pat daugiau informacijos galite rasti <a href="%3$s">README</a> faile.</p><p><strong>Dabar turite ištrinti, perkelti arba pervadinti įdiegimo katalogą (install). Jeigu to nepadarysite, bus prieinamas tik administratoriaus valdymo pultas.</strong></p>',
	'INSTALL_INTRO'	=> 'Sveiki atvykę į diegimo proceso pradžią',
	'INSTALL_INTRO_BODY'	=> 'Šio proceso pagalba galite įdiegti phpBB savo serveryje.</p><p>Norėdami tęsti, turėsite įrašyti duomenų bazės nustatymus. Jeigu jų nežinote, susisiekite su savo tinklapių talpinimo paslaugų teikėju ir paklauskite. Be šių nustatymų jūs negalėsite tęsti diegimo. Jums prireiks:</p>
	...
	'INST_ERR_DB_FORUM_PATH'	=> 'Nurodytas duomenų bazės failas yra jūsų diskusijų lentos katalogų medyje. Jūs turėtumėte padėti šį failą į internetiam serveriui neprieinamą vietą.',
	...
	'INST_ERR_DB_NO_FIREBIRD'	=> 'Firebird versija jūsų serveryje yra senesnė nei 2.0. Atnaujinkite į naujesnę versiją.',
	'INST_ERR_DB_NO_FIREBIRD_PS'	=> 'Duomenų bazėję, kurią pasirinkote, puslapio dydis (page size) yra mažesnis nei 8192. Jis turi būti bent 8192.',
	...
	'INST_ERR_NO_DB'	=> 'PHP neturi reikiamo mobulio pasirinktam duomenų bazės tipui.',
	...
	'OVERVIEW_BODY'	=> 'Sveiki atvykę į viešąjį kandidatinį tolesnės pagrindinės phpBB versijos (po 2.0.x) phpBB 3.0 leidimą! Šis leidimas yra pritaikytas plačiam naudojimui ir skirtas surasti paskutines klaidas.</p><p>Norėdami sužinoti daugiau apie phpBB3 diegimą, skaitykite <a href="../docs/INSTALL.html">diegimo vadovą</a></p><p><strong style="text-transform: uppercase;">Pastaba:</strong> Šis leidimas <strong style="text-transform: uppercase;">ne galutinis</strong>. Patariame sulaukti galutinio leidimo ir nenaudoti šios diskusijų lentos produkciniame lygyje.</p><p>Šios diegimo sistemos pagalba galėsite įdiegti phpBB, konvertuoti iš kitų diskusijų lentų programinės įrangos paketų bei atnaujinti phpBB į naujausią versiją. Daugiau informacijos apie tai galite rasti pasirinkę kurį nors meniu punktą viršuje.',
	...
	'PHP_REGISTER_GLOBALS_EXPLAIN'	=> 'Jeigu šis nustatymas yra įjuntas phpBB vistiek veiks. Tačiau, saugumo sumetimais, rekomenduojama register_globals išjungti.',
	...
	'PRE_CONVERT_COMPLETE'	=> 'Visi pirminiai konversijos etapai baigti sėkmingai. Dabar galite pradėti tikrąjį konversijos procesą. Įsidėmėkite, kad kai kuriuos dalykus turėsite nustatyti patys. Po konversijos proceso patikrinkite vartotojams priskirtas teises, jeigu reikia atstatykite paieškos indeksą, taip pat įsitikinkite kad visi failai buvo teisingai perkopijuoti, pavyzdžiui avatarai ir šypsenėlės.',
	...
	'RETRY_WRITE'	=> 'Pakartotinis kofigūracijos rašymas',
	...
	'STAGE_CONFIG_FILE'	=> 'Konfigūracinis failas',
	...
	'SUB_INTRO'	=> 'Įžanga',
	'SUB_LICENSE'	=> 'Licensija',
	'SUB_SUPPORT'	=> 'Palaikymas',
	'SUCCESSFUL_CONNECT'	=> 'Prisijungti pavyko',
	'SUPPORT_BODY'	=> 'Kandidatinio leidimo metu pilnas palaikymas teikiamas <a href="http://www.phpbb.com/community/viewforum.php?f=46">phpBB 3.0.x palaikymo forumuose</a>. Mes atsakysime į bendrus diegimo klausimus, konfigūracines problemas, konversijos problemas ir teiksime palaikymą problemoms, kurios iškyla dėl programinės įrangos klaidų. Taip pat galite diskutuoti apie modifikacijas ir kitus kodo/stiliaus pakeitimus.</p><p>Daugiau informacijos rasite <a href="http://www.phpbb.com/support/documentation/3.0/quickstart/">Greitajame vadove</a> ir <a href="http://www.phpbb.com/support/documentation/3.0/">dokumentacijos puslapyje</a>.</p><p>Jeigu norite gauti visas naujausias naujienas ir žinutes apie naujus programinės įrangos leidimus, prisijunkite prie <a href="http://www.phpbb.com/support/">mūsų el. pašto konferencijos</a>?',
	...
	'ALL_FILES_UP_TO_DATE'	=> 'Jūs naudojate naujausią phpBB versiją. <a href="../ucp.php?mode=login">Prisijunkite prie diskusijų lentos</a> ir patikrinkite ar viskas veikia korektiškai. Nepamirškite ištrinti, pervadinti arba perkelti diegimo katalogo (install)!',
	...
	'COLLECTED_INFORMATION'	=> 'Surinkta informacija apie failus',
	...
	'CURRENT_FILE'	=> 'Dabartinis failas',
	...
	'DIFF_SEP_EXPLAIN'	=> 'Dabartinio failo pabaiga / naujesnio failo pradžia',
	...
	'FILES_NEW_EXPLAIN'	=> 'Šie failai neegzistuoja dabartinėje diskusijų lentoje.',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'	=> 'Šie failai nebuvo pakeisti ir atitinka originalius failus senojoje phpBB versijoje.',
	...
	'MERGE_MOD_FILE_OPTION'	=> 'Sujungti ir panaudoti esamą pakeistą kodą konfliktuojančiame bloke',
	'MERGE_NEW_FILE_OPTION'	=> 'Sujungti ir panaudoti naują kodą konfliktuojančiame bloke',
	'MERGE_SELECT_ERROR'	=> 'Blogai pasirinktas konfliktuojančių failų sujungimo metodas.',
	'NEW_FILE'	=> 'Naujas atnaujintas failas',
	...
	'NO_UPDATE_FILES_EXPLAIN'	=> 'Šie failai yra nauji arba pekeisti, tačiau katalogas, kuriame jie turi būti, neegzistuoja. Jeigu šiame sąraše yra failų ne tik iš language/ ir styles/ katalogų, tai greičiausiai jūs pakeitėte katalogų struktūrą, todėl atnaujinimo procesas gali įvykti ne iki galo.',
	...
	'UPDATE_INSTRUCTIONS'	=> '		<h1>Pranešimas apie leidimą</h1>
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Eikite į <a href="http://www.phpbb.com/downloads/" title="http://www.phpbb.com/downloads/">phpBB.com atsisiuntimų puslapį</a> ir atsisiųstkite teisingą "Automatinio atnaujinimo paketo" archyvą.<br /><br /></li>
	...
	'VERSION_CHECK_EXPLAIN'	=> 'Patikrinimai skirti nustatyti ar naudojate naujausią phpBB versiją.',
	'VERSION_NOT_UP_TO_DATE'	=> 'Jūs naudojate ne naujausią phpBB versiją. Pradėkite atnaujinimo procesą.',
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'Jūs naudojate ne naujausią phpBB versiją.<br />Apačioje rasite nuorodą į pranešimą apie naujausią leidimą. Taip pat rasite instrukcijas, kaip atnaujinti jūsų naudojamą versiją.',
	'VERSION_UP_TO_DATE'	=> 'Jūs naudojate naujausią phpBB versiją. Jos nereikia atnaujinti. Tačiau vistiek galite tęsti ir patikrinti kiekvieną failą atskirai.',
	'VERSION_UP_TO_DATE_ACP'	=> 'Jūs naudojate naujausią phpBB versiją. Jos nereikia atnaujinti.',
	...
	'CONFIG_SITE_DESC'	=> '_Trumpas_ sakinys apibūdinantis jūsų diskusijų lentą',
	'CONFIG_SITENAME'	=> 'jūsųdomenas.com',
	'DEFAULT_INSTALL_POST'	=> 'Tai yra pavyzdinis pranešimas. Jeigu pageidaujate, galite ištrinti šį pranešimą, šią temą ir net šį forumą!',
	...
	'FORUMS_FIRST_CATEGORY'	=> 'Mano pirmoji kategorija',
	'FORUMS_TEST_FORUM_DESC'	=> 'Tai tik testinis forumas.',
	'FORUMS_TEST_FORUM_TITLE'	=> 'Testinis forumas 1',
	'RANKS_SITE_ADMIN_TITLE'	=> 'Vyr. diskusijų administratorius',
	'REPORT_WAREZ'	=> 'Pranešime yra nuorodų į nelegalę arba piratinę programinę įrangą.',
	...
	'SMILIES_TWISTED_EVIL'	=> 'Suktas piktadaris',
