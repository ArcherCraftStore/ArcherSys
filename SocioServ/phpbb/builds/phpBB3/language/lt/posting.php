...
$lang = array_merge($lang, array(
	...
	'BBCODE_F_HELP'	=> 'Šrifto dydis: [size=x-small]mažas tekstas[/size]',
	...
	'MAX_FONT_SIZE_EXCEEDED'	=> 'Jūs galite naudoti tik šriftą, kurio dydis neviršyja %1$d.',
	...
	'MAX_IMG_WIDTH_EXCEEDED'	=> 'Jūsų paveikslėliai negali būti platesni nei %1$d pikslekių pločio.',
	...
	'NO_DELETE_POLL_OPTIONS'	=> 'Jūs negalite ištrinti egzistuojančių apklausos punktų.',
	...
	'PHP_SIZE_NA'	=> 'Prikabintas failas per didelis.<br />Nepavyko nustatyti maksimalaus leistimo failų dydžio konfigūraciniame PHP faile php.ini.',
	'PHP_SIZE_OVERRUN'	=> 'Prikabintas failas per didelis. Maksimalus leistinas failo dydis yra %d MB.<br />Taip nustatyta konfigūraciniame faile php.ini.',
	...
	'POLL_MAX_OPTIONS'	=> 'Punktų skaičius vartotojui',
	'POLL_MAX_OPTIONS_EXPLAIN'	=> 'Kiek punktų gali pasirinkti kiekvienas vartotojas.',
	'POLL_OPTIONS'	=> 'Apklausos punktai',
	'POLL_OPTIONS_EXPLAIN'	=> 'Kiekvieną punktą rašykite naujoje eilutėje. Iš viso galite įrašyti iki <strong>%d</strong> punktų.',
	'POLL_OPTIONS_EDIT_EXPLAIN'	=> 'Kiekvieną punktą rašykite naujoje eilutėje. Iš viso galite įrašyti iki <strong>%d</strong> punktų. Jeigu pridėsite arba ištrinsite nors vieną punktą, balsai bus skaičiuojami iš naujo.',
	...
	'POST_DELETED'	=> 'Šis pranešimas sėkmingai ištrintas.',
	'POST_EDITED'	=> 'Šis pranešimas sėkimingai pakeistas.',
	'POST_EDITED_MOD'	=> 'Šis pranešimas sėkmingai pakeistas, tačiau prieš tai kai jis bus parodytas vietai, pranešimas turi būti patvirtintas moderatoriaus.',
	...
	'QUOTE_DEPTH_EXCEEDED'	=> 'Jūs galite grupuoti tik %1$d citatų vieną ant kitos.',
	'SAVE'	=> 'Išsaugoti',
	'SAVE_DATE'	=> 'Išsaugota',
	...
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Niekada nesibaigiančiai dažnai/svarbiai temai įrašykite 0 arba palikitę tuščią.',
	'STYLES_TIP'	=> 'Pastaba: stilius galite taikyti ir pasirinktam tekstui.',
	'TOO_FEW_CHARS'	=> 'Jūsų pranešimas yra per trumpas.',
	'TOO_FEW_POLL_OPTIONS'	=> 'Turite įrašyti bent du apklausos punktus.',
	...
	'TOO_MANY_POLL_OPTIONS'	=> 'Jūs įrašėte per daug apklausos punktų.',
	...
	'TOO_MANY_USER_OPTIONS'	=> 'Jūs negalite nurodyti daugiau punktų vienam vartotojui nei jų yra iš viso.',
