...
$lang = array_merge($lang, array(
	...
	'ACP_BOARD_CONFIGURATION'	=> 'Site konfigürasyonu',
	'ACP_BOARD_FEATURES'		=> 'Site özellikleri',
	'ACP_BOARD_MANAGEMENT'		=> 'Site yönetimi',
	'ACP_BOARD_SETTINGS'		=> 'Site ayarları',
	...
	'ACP_GROUPS_PERMISSIONS'		=> 'Grupların İzinleri',
	...
	'LOGIN_ADMIN'			=> 'Siteyi yönetmek için doğrulanmış bir kullanıcı olmalısınız.',
	'LOGIN_ADMIN_CONFIRM'	=> 'Siteyi yönetmek için kendinizi yeniden doğrulamalısınız.',
	...
	'NOTIFY'				=> 'Bildiri',
	'NO_ADMIN'				=> 'Bu siteyi yönetmek için yetkiniz yok.',
...
$lang = array_merge($lang, array(
  ...
  'PURGE_CACHE'          => 'Zula temizliği', 
  'PURGE_CACHE_CONFIRM'   => 'Zulayı temizlemek istediğinize emin misiniz?', 
  'PURGE_CACHE_EXPLAIN'   => 'Tüm zula ile ilgili ögeleri temizler; bu, zulalanan herhangi şablon dosyalarını ya da sorgularını kapsar.',
  
	'RESET_DATE'			=> 'Sitenin açılış tarihini sıfırla',
	'RESET_DATE_CONFIRM'			=> 'Sitenin açılış tarihini sıfırlamak istediğinize emin misiniz?',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Bu liste, aktif olmayan hesaplara sahip en son kayıt olan 10 kullanıcının bir listesidir. Tam bir listeyi uygun menü ögesinden görebilirsiniz ya da eğer isterseniz altlarındaki linki izleyerek bu kullanıcıları aktif edebilir, silebilir ya da hatırlatma (bir e-posta yoluyla) yapabilirsiniz.',
...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_FEATURES'		=> '<strong>Site ayarları değiştirildi</strong>',
	...
	'LOG_CONFIG_SETTINGS'		=> '<strong>Site ayarları değiştirildi</strong>',
  ...
  'LOG_TOPIC_DISAPPROVED' => '<strong>“%1$s” isimli başlık şu sebepten dolayı onaylanmadı</strong><br />%2$s',
	...
	'LOG_PURGE_CACHE'    => '<strong>Zula temizlendi</strong>',
