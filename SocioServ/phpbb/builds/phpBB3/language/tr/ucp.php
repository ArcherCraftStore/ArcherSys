...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> '"%1$s" (diğer anlamda "biz", "tarafımız", "bizim", "%1$s", "%2$s") tarafından çoğaltılan, yasal olarak sınırlı olan alttaki koşulları kabul etmiş sayılıyorsunuz. Eğer yasal olarak sınırlı olan alttaki koşulların tümünü kabul etmiyorsanız o zaman lütfen "%1$s" sitesine giriş yapmayın ve/veya kullanmayın. Biz bu koşulları herhangi bir zamanda değiştirebiliriz ve sizi bilgilendirebiliriz, buna rağmen kendiniz düzenli olarak bu koşulları tekrar gözden geçirerek  "%1$s" sitesini kullanmaya devam edebilirsiniz, yasal olarak sınırlı olan bu koşulların güncellenmesi ve/veya düzenlenmesi durumunda meydana gelebilecek değişiklikleri de kabul etmiş sayılırsınız.<br />
	<br />
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_COPPA'					=> 'Hesabınız oluşturuldu fakat onaylanmadı, lütfen detaylar için e-posta adresinizi kontrol edin.',
 	'ACCOUNT_EMAIL_CHANGED'			=> 'Hesabınız güncellendi. Fakat, bu site e-posta değişikliklerinde yeniden hesap aktivasyonu istiyor. Belirttiğiniz yeni e-posta adresine bir aktivasyon şifresi gönderildi. Lütfen daha fazla bilgi için e-posta kutunuzu kontrol edin.',
 	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Hesabınız güncellendi. Fakat, bu site e-posta değişikliklerinde yöneticiler tarafından yapılması gereken yeniden hesap aktivasyonu istiyor. Yöneticilere bir e-posta gönderildi ve onlar size hesabınız yeniden aktif edildiğinde bilgi vereceklerdir.',
	'ACCOUNT_INACTIVE'				=> 'Hesabınız oluşturuldu. Fakat, bu site hesap aktivasyonu istemektedir, belirlediğiniz e-posta adresine bir aktivasyon şifresi gönderildi. Lütfen daha fazla bilgi için e-posta adresinizi kontrol edin.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Hesabınız oluşturuldu. Fakat, bu site yönetici grubu tarafından yapılması gereken hesap aktivasyonu istemektedir. Onlara şu an bir e-posta gönderildi ve hesabınız aktif edildiği zaman bilgilendirileceksiniz.',
	...
	'AVATAR_GENERAL_UPLOAD_ERROR'		=> 'Avatar yüklenemiyor %s.',
	'AVATAR_PAGE'					=> 'Sayfa',
	...
	'BOOKMARKS_DISABLED'		=> 'Bu sitede yer imleri kapatıldı.',
	...
	'CONFIRM_EXPLAIN'			=> 'Otomatik kayıtları önlemek için site yöneticisi bir onay kodu girmenizi istiyor. Alttaki resmin içerisinde gösterilen kodu görmelisiniz. Eğer kodu bozuk görüyor veya okuyamıyorsanız lütfen %sSite Yöneticisi%s ile iletişime geçin.',
	...
	'COPPA_EXPLAIN'				=> 'Not: Gönder linkine tıkladığınız zaman hesabınız oluşturulacaktır. Fakat kaydınız anne, baba veya velinize onaylatana kadar aktif olmayacaktır. Gerekli detayların kopyasını nereye göndereceğiniz konusunda bir e-posta alacaksınız.',
	...
	'DELETE_COOKIES_CONFIRM'	=> 'Bu site tarafından ayarlanan tüm çerezleri silmek istediğinize emin misiniz?',
	...
	'FORWARD_PM'				=> 'ÖM İlet',
	'FORCE_PASSWORD_EXPLAIN'		=> 'Siteyi dolaşmaya devam etmeden önce şifrenizi değiştirmeniz gerekmektedir.',
	...
	'HIDE_ONLINE_EXPLAIN'      => 'Bu ayarı değiştirirseniz siteye yapacağınız sonraki ziyaretinize kadar etkisi olmayacaktır.',
	...
	'ITEMS_REQUIRED'			=> '* ögeleri ile işaretlenen profil alanları gerekli tutulduğu için bunları doldurmalısınız.',

	'JOIN_SELECTED'				=> 'Seçilene katıl',

	'LANGUAGE'				=> 'Dil',
	'LINK_REMOTE_AVATAR'			=> 'Uzak siteden link ver',
	'LINK_REMOTE_AVATAR_EXPLAIN'		=> 'Avatar resmini içeren link vermek istediğiniz URL adresini girin.',
	...
	'LOGOUT_FAILED'       => 'Çıkış yapamadınız, oturumunuz ile uyumlu istek yok. Eğer problemlerle karşılaşmaya devam ederseniz lütfen site yöneticisi ile iletişime geçin.',
	...
	'NOTIFY_METHOD_EXPLAIN'		=> 'Bu site ile gönderilecek mesajlar için metod.',
	...
	'PERMISSIONS_TRANSFERRED'	=> 'İzinler başarıyla şuradan transfer edildi: <strong>%s</strong>, şimdi bu kullanıcının izinleri ile siteyi dolaşabilirsiniz.<br />Not: Yönetici izinleri transfer edilmedi. Herhangi bir zamanda izinlerinize geri dönebilirsiniz.',
	'PM_DISABLED'				=> 'Bu sitede özel mesajlaşma kapatıldı.',
	'PM_FROM'					=> 'Kimden',
	...
	'UCP_EMAIL_ACTIVATE'		=> 'Not: Hesabınız aktif edilmeden önce doğru bir e-posta adresi girmelisiniz. Belirttiğiniz adresten bir e-posta alacaksınız ve içeriğinde bir aktivasyon linki bulunacaktır.',
	...
	'UPLOAD_AVATAR_URL_EXPLAIN'		=> 'Resmin olduğu sitenin URL adresini girin. Resim bu siteye kopyalanacaktır.',
  ...
  'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'=> 'Kullanıcı adı %1$d ve %2$d karakter arasındaki uzunlukta olmalıdır ve harf, sayı, boşluk veya -+_[] karakterleri kullanılmalıdır.',
	...
	'PM_RULE' => array(
		...
		'IS_GROUP'		=> 'kullanıcı gruplarındaysa',
