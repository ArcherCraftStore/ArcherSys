...
* @copyright (c) 2005 phpBB China Group 
...
$lang = array_merge($lang, array(
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'		=> '每个文件的最大尺寸, 0表示无限制.',
	'ATTACH_MAX_PM_FILESIZE'			=> '最大短信文件尺寸',
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> '每个用户短信附件的最大可用空间, 0表示无限制.',
	...
	'MIN_THUMB_FILESIZE'			=> '最小缩略尺寸',
	'MIN_THUMB_FILESIZE_EXPLAIN'	=> '当图片尺寸小于这个时不创建缩略图.',
	'MODE_INLINE'					=> '图文混排',
	'MODE_PHYSICAL'					=> '物理',
	...
	'SECURE_ALLOW_DENY'				=> '允许/禁止 列表',
	'SECURE_ALLOW_DENY_EXPLAIN'		=> '当安全下载启用于允许/禁止 列表 - 一个 <strong>白名单</strong> (允许) 或者一个 <strong>黑名单</strong> (禁止)时更改默认动作',
	'SECURE_DOWNLOADS'				=> '允许安装下载',
	'SECURE_DOWNLOADS_EXPLAIN'		=> '当开启选项后, 下载将仅限于您设定的IP地址/主机名.',
	'SECURE_DOWNLOAD_NOTICE'		=> '安全下载没有启用. 下面的设置将在启用安全下载后应用.',
	'SECURE_DOWNLOAD_UPDATE_SUCCESS'=> 'IP 列表更新完成.',
	'SECURE_EMPTY_REFERRER'			=> '允许空转向',
	'SECURE_EMPTY_REFERRER_EXPLAIN'	=> '安装下载基于转向. 您希望允许忽略转向的下载吗?',
