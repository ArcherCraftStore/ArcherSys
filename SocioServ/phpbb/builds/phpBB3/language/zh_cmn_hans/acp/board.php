...
$lang = array_merge($lang, array(
	...
	'CHECK_DNSBL_EXPLAIN'			=> '如果启用, 用户的IP地址将被检查以防御如下在注册和发帖时的 DNSBL 服务: <a href="http://spamcop.net">spamcop.net</a>, <a href="http://dsbl.org">dsbl.org</a> and <a href="http://www.spamhaus.org">www.spamhaus.org</a>. 这个检查将耗费一些时间, 取决于服务器的设置. 如果让论坛变得很漫或产生很多错误报告, 请禁用这个功能.',
	'CLASS_B'						=> 'A.B',
	'CLASS_C'						=> 'A.B.C',
...
$lang = array_merge($lang, array(
	...
	'ERR_JAB_AUTH'			=> '没有得到Jabber服务器认证.',
	'ERR_JAB_CONNECT'		=> '无法连接Jabber服务器.',
	'JAB_ENABLE'				=> '启用Jabber',
	...
	'JAB_USERNAME'				=> 'Jabber用户名',
	'JAB_USERNAME_EXPLAIN'		=> '请指定一个已经注册的用户, 它将不会被检测是否存在.',
));
