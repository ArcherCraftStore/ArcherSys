...
$lang = array_merge($lang, array(
	...
	'PERMISSIONS_TRANSFERRED_EXPLAIN'	=> '您现在使用来自于 %1$s 的权限. 您可以以这个用户的权限浏览版面但是不能访问管理员控制面板因为管理员权限没有被传递. 您可以随时 <a href="%2$s"><strong>回复您的权限设置</strong></a>.',
	'PIXEL'							=> 'px',	
...
$lang = array_merge($lang, array(
	...
	'LOG_MOVE'					=> '<strong>移动主题</strong><br />» 自 %s',
	...
	'LOG_TOPIC_DELETED'			=> '<strong>删除主题</strong><br />» %s',
	...
	'LOG_DISALLOW_ADD'		=> '<strong>添加禁止使用的用户名</strong><br />» %s',
	'LOG_DISALLOW_DELETE'	=> '<strong>删除禁止使用的用户名</strong>',
