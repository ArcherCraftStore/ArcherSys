...
$lang = array_merge($lang, array(
	...
	'FORUM_ADMIN'						=> '版面管理',
	'FORUM_ADMIN_EXPLAIN'				=> '在phpBB3中没有分区, 所有都是基于版面. 每个版面可以拥有无限的子版面, 并且您可以设置哪些能发帖哪些不能. (例如是否表现为分区). 这里您能添加, 编辑, 删除, 锁定, 解锁各个版面并设置一些额外控制. 如果您的帖子和主题统计失去同步, 您可以重新统计一下版面. <strong>要显示新创建的版面，您必须为它复制或设置适当的权限.</strong>',
