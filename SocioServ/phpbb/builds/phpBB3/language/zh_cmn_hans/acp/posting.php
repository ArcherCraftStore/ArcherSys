...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> '这个控制面板中可以添加, 编辑, 删除需要过滤的词汇. 并且用户将不允许使用包含这些敏感词的用户名注册帐号. 可以使用通配符, 例如 *test* 将匹配detestable, test*将匹配testing, *test将匹配detest',
	'ADD_WORD'				=> '添加敏感词',
