...
$lang = array_merge($lang, array(
	...
	'EDIT_THEME'						=> '编辑风格主题',
	'EDIT_THEME_EXPLAIN'				=> '这里您可以编辑选中的主题. 更改颜色, 图片等等. 您可以使用基本界面修改基本的颜色, 或使用高级界面"裸CSS"模式, 这允许您添加额外的参数例如边界等等. 只需要设置您需要的参数, 其余的留空或不要定义.',
