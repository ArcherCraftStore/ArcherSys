...
// TODO: write some more introductions here
	...
	'INSTALL_SEND_CONFIG'		=> '很不幸，phpBB没能将配置信息直接写入您的 config.php 文件。这可能是由于此文件不存在或不可写入。下面将给出一些选项帮助您完成设置 config.php。',
	'INSTALL_START'				=> '开始安装',
	'INSTALL_TEST'				=> '重新检测',
	'INST_ERR'					=> '安装进程出错',
	...
	'INST_ERR_DB_NO_MYSQLI'		=> '服务器内安装的 MySQL 版本与您选择的 “MySQL with MySQLi Extension” 选项不兼容，请尝试 “MySQL” 选项。',
...
// TODO: Write some explanatory introduction text
	...
	'OVERVIEW_BODY'					=> '欢迎使用phpBB3.0 候选发布版本! 这个版本的发布是为了得到更广泛的使用, 从而帮助我们检验已经被修正的bug.</p><p>请阅读 <a href="../docs/INSTALL.html">安装指南</a> 以得到更多的安装信息</p><p><strong style="text-transform: uppercase;">注意:</strong> 这个发行版 <strong style="text-transform: uppercase;">并不是正式版</strong>. 您可能需要等待最终发行版的发布.</p><p>这个安装系统将引导您完成安装phpBB, 或者升级phpBB, 或者转换其他程序数据到phpBB的全过程, 需要每个选项的更多信息, 请从上面的菜单选择相应的页面.',
...
// TODO: Write some text on obtaining support
	'SUPPORT_BODY'				=> '在测试阶段, 我们提供有限的技术支持于 <a href="http://www.phpbb.com/phpBB/viewforum.php?f=46">phpBB 3.0 测试支持版面</a>. 我们将回答一般的安装设置问题, 以及和bug相关的一般问题. 我们不提供插件, 自定义代码/风格和任何实际应用的支持.</p><p>需要更多的帮助, 请访问 <a href="http://www.phpbb.com/support/documentation/3.0/quickstart/">如何快速上手</a>.</p><p>如果需要及时获取最新的新闻和发布, 请 <a href="http://www.phpbb.com/support/">加入我们的邮件列表</a>',
	'SYNC_FORUMS'				=> '开始同步版面',
