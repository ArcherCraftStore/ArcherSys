...
$lang = array_merge($lang, array(
	...
	'AVATAR_CATEGORY'				=> '分类',
	'AVATAR_EXPLAIN'				=> '最大尺寸：宽 %1$d 象素，高 %2$d 象素，文件大小 %3$dkB。',
	...
	'CONFIRM_EMAIL_EXPLAIN'		=> '如果您在修改email地址，您需要填入这项内容。',
	...
	'FOE_MESSAGE'				=> '从黑名单来的短信',
	'FOES_EXPLAIN'				=> '黑名单上的用户默认被忽略。这些用户的帖子将不会全部显示并且不允许对您发送私人短信。请注意这不能阻止版主和管理员的短信。',
	'FOES_UPDATED'				=> '您的黑名单已经更新',
	...
	'NOT_ADDED_FRIENDS_FOES'		=> '您不能添加正在黑名单上的用户到您的好友列表',
	'NOT_ADDED_FRIENDS_SELF'		=> '您不能将自己添加为好友',
	'NOT_ADDED_FOES_MOD_ADMIN'		=> '您不能添加管理员和版主到黑名单。',
	'NOT_ADDED_FOES_ANONYMOUS'		=> '您不能添加匿名用户到黑名单。',
	'NOT_ADDED_FOES_FRIENDS'		=> '您不能添加正在好友列表上的用户到黑名单。',
	'NOT_ADDED_FOES_SELF'			=> '您不能将自己添加到黑名单。',
	'NOT_AGREE'						=> '我不同意这些条款',
	...
	'PASSWORD_UPDATED'			=> '您的密码已经发送到您的原始email地址。',
	'PERMISSIONS_RESTORED'		=> '成功回复原权限。',
	'PERMISSIONS_TRANSFERRED'	=> '成功转换权限自 <strong>%s</strong>，您现在可以使用用户权限浏览版面.<br />请注意管理员权限不会被转换。您可以在任何时候恢复回原权限。',
