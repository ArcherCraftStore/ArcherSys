...
//-->]]></script>
	...
	<xsl:template name="give-header">
		...
		<div id="modDisclaimer">
			...
			<p>For Security Purposes, Please Check: <a href="http://startrekguide.com/forum">http://startrekguide.com/forum/</a> for the latest version of this MOD. Downloading this MOD from other sites could cause malicious code to enter into your phpBB Forum. As such, StarTrekGuide will not offer support for MOD's not offered in our MOD-Database, located at: <a href="http://startrekguide.com/forum/">http://startrekguide.com/forum/</a></p>
			<h2>Author Notes</h2>
			...
			<xsl:if test="./mod:mod-version/mod:minor mod 2 != 0 or ./mod:mod-version/mod:major = 0">
				<p>
					<strong class="red">phpBB3-Beta is development quality. It is not recommended that you run it live.</strong>
				</p>
			</xsl:if>
		</div>
		<hr />
	...
	<xsl:template name="give-author">
		<dl>
			...
			<dd>
				<a href="http://startrekguide.com/forum/memberlist.php?mode=viewprofile&amp;un={mod:username}">
