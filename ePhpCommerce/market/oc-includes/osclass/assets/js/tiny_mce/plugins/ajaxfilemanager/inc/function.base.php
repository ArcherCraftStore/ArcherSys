...
function myRealPath($path) {
 ...
 function getRealPath($value)
 {
	...
	function getFileUrl($value)
	{
		...
		return WEB_PATH . removeBeginingSlash(backslashToSlash($output)); //$protocol . "://" .  addTrailingSlash(backslashToSlash($_SERVER['HTTP_HOST'])) . removeBeginingSlash(backslashToSlash($output));
	}
