								...
								<tr>
									<td>
										<table>
											<tr>
												<td>
									&#8226;&nbsp; <a href="<?php echo "$PHP_SELF";?>?Mode=signup&Action=signup_main" class="eleven"><?php echo SIGN_UP;?></a>
												</td>
											</tr>
											<tr>
												<td>
									&#8226;&nbsp; <a href="<?php echo "$PHP_SELF";?>?Mode=signup&Action=display_league_settings" class="eleven"><?php echo VIEW_LEAGUE_SETTINGS;?></a>
												</td>
											</tr>
										</table>
									</td>
