...
require_once(OC::$APPSROOT.'/apps/ocdownloader/lib/ocDownloader.class.php');
require_once(OC::$APPSROOT.'/apps/ocdownloader/lib/ocDownloaderYT.class.php');
require_once(OC::$APPSROOT.'/apps/ocdownloader/lib/ocDownloaderPB.class.php');
