...
*
* @package language
* @version $Id: install.php 196 2007-05-18 17:37:40Z philipp $
...
$lang = array_merge($lang, array(
	...
	'CAT_UPDATE'				=> 'Update',
	'CHANGE'					=> 'Ändern',
	'CHECK_TABLE_PREFIX'		=> 'Bitte prüfe deinen Tabellen-Präfix und versuche es erneut.',
	...
	'COULD_NOT_FIND_PATH'		=> 'Der Pfad zu deinem alten Board konnte nicht gefunden werden. Bitte prüfe deine Einstellungen und versuche es erneut.<br />» Angegebener Quell-Pfad: %s',
...
// TODO: Write some explanatory introduction text
	...
	'OVERVIEW_BODY'					=> 'Willkommen zu unserem öffentlichen Release Candidate der nächsten Generation von phpBB nach 2.0.x, phpBB 3.0! Diese Veröffentlichung ist für eine breitere Nutzung gedacht, um die letzten Fehler und Probleme finden zu können.</p><p>Bitte lese <a href="../docs/INSTALL.html">die Installationshinweise</a> für weitere Informationen zur Installation von phpBB3.</p><p><strong style="text-transform: uppercase;">Beachte:</strong> Dies ist <strong style="text-transform: uppercase;">immer noch keine finale</strong> Veröffentlichung. Eventuell willst du bis zur endgültigen Version warten, bevor du die Software produktiv einsetzt.</p><p>Dieses Installations-System wird dich durch die Installation von phpBB, der Konvertierung von einem anderen Software-Paket oder dem Update auf die aktuelle Version von phpBB führen. Für weitere Informationen zu den einzelnen Optionen wähle diese aus dem obigen Menü aus.',
...
// TODO: Write some text on obtaining support
	'SUPPORT_BODY'				=> 'Während der Release Candidate-Phase wird vollständiger Support im <a href="http://www.phpbb.com/community/viewforum.php?f=46">phpBB 3.0.x-Support-Forum</a> angeboten. Wir werden Antworten auf allgemeine Setup-Fragen, Konfigurations- und Konvertierungsprobleme und Unterstützung bei der Bestimmung gängiger Probleme, die hauptsächlich auf Bugs zurückzuführen sind, geben. Wir werden Diskussionen über Modifikationen oder eigene Code-/Style-Änderungen erlauben.</p><p>Für weiterführende Unterstützung verwende bitte unseren <a href="http://www.phpbb.com/support/documentation/3.0/quickstart/">Quick Start Guide</a> und die <a href="http://www.phpbb.com/support/documentation/3.0/">Dokumentation</a>.</p><p>Um immer die neuesten Informationen zu Updates und Veröffentlichungen zu erhalten, solltest du dich für den <a href="http://www.phpbb.com/support/">phpBB Newsletter</a> anmelden.',
	...
	'TABLE_PREFIX_SAME'			=> 'Der Tabellen-Präfix muss mit dem übereinstimmen, der von der Software, von der du konvertieren möchtest, genutzt wird.<br />» Der angegebene Tabellen-Präfix lautete %s.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Alle Dateien sind auf dem Stand der neuesten phpBB-Version. Du solltest dich nun <a href="../ucp.php?mode=login">auf deinem Board anmelden</a> und prüfen, ob alles einwandfrei funktioniert. Vergiss nicht, das Installations-Verzeichnis „install“ zu löschen, umzubenennen oder zu verschieben!',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'	=> 'Die folgenden Dateien wurden nicht geändert und entsprechen den originalen phpBB-Dateien der Version, von der aus du updaten willst.',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Gehe zur <a href="http://www.phpbb.com/downloads/" title="http://www.phpbb.com/downloads/">phpBB.com-Downloadseite</a> und lade das entsprechende „Automatisches-Update-Paket“ herunter.<br /><br /></li>
	...
	'VERSION_CHECK_EXPLAIN'		=> 'Prüft, ob die phpBB-Version, die du einsetzt, auf dem neuesten Stand ist.',
	'VERSION_NOT_UP_TO_DATE'	=> 'Deine phpBB-Version ist nicht auf dem neuesten Stand. Bitte fahre mit der Aktualisierung fort.',
	'VERSION_NOT_UP_TO_DATE_ACP'=> 'Deine phpBB-Version ist nicht auf dem neuesten Stand<br />Im Folgenden findest du einen Link zu der Release-Ankündigung der neuesten Version sowie Informationen, wie du deine Version aktualisieren kannst.',
	'VERSION_UP_TO_DATE'		=> 'Deine Installation ist auf dem neuesten Stand, für deine phpBB-Version sind keine Updates verfügbar. Du kannst trotzdem fortfahren und die Dateien auf Gültigkeit überprüfen.',
	'VERSION_UP_TO_DATE_ACP'	=> 'Deine Installation ist auf dem neuesten Stand, für deine phpBB-Version sind keine Updates verfügbar. Es ist nicht nötig, die Installation zu aktualisieren.',
...
$lang = array_merge($lang, array(
	...
	'CONFIG_SITE_DESC'				=> 'Ein _kurzer_ Text, der dein Forum beschreibt',
	'CONFIG_SITENAME'				=> 'deinedomain.tld',

	'DEFAULT_INSTALL_POST'			=> 'Dies ist ein Beispielsbeitrag deiner phpBB3-Installation. Wenn du willst, kannst du ihn, dieses Thema und sogar das Forum löschen, da alles zu funktionieren scheint!',
