...
$lang = array_merge($lang, array(
	...
	'AVATAR_EXPLAIN'				=> 'Maksimikoko; leveys %1$d pikseliä, korkeus %2$d pikseliä, tiedoston koko %3$dkB.',
	'AVATAR_FEATURES_DISABLED'		=> 'Avatar-toiminnot ovat tällähetkellä pois käytöstä.',
	...
	'BOOKMARKS_EXPLAIN'			=> 'Voit lisätä kirjanmerkin myöhempää tarkastelua varten. Laita rasti ruutuun jokaiselle kirjanmerkille, jonka, haluat poistaa. Paina sen jälkeen <em>Poista valitut kirjanmerkit</em> poistaaksesi valitut.',
	'BOOKMARKS_DISABLED'		=> 'Kirjanmerkit ovat poissa käytöstä tällä keskustelufoorumilla',
	'BOOKMARKS_REMOVED'			=> 'Kirjanmerkit poistettu',

	'CANNOT_EDIT_MESSAGE_TIME'	=> 'Et voi enään muokata tai poistaa tätä viestiä',
	...
	'CURRENT_PASSWORD'			=> 'Käytössä oleva salasana',
	'CURRENT_PASSWORD_EXPLAIN'	=> 'Tekemäsi muutokset täytyy vahvistaa nykyisellä salasanallasi, mikäli haluat vaihtaa sähköpostiosoitetta tai käyttäjätunnusta.',
	...
	'DOWNLOADS'					=> 'Lataukset',
	'DRAFTS_DELETED'			=> 'Kaikki valitut vefokset on poistettu.',
	'DRAFTS_EXPLAIN'			=> 'Täällä voit katsoa, muokata ja poistaa valitsemiasi luonnoksia.',
	'DRAFT_UPDATED'				=> 'Luonnos päivitetty.',
	...
	'EMAIL_TAKEN_EMAIL'			=> 'Antamasi sähköpostiosoite on jo läytössä.',
	...
	'FRIENDS'					=> 'Ystävät',
	'FRIENDS_EXPLAIN'			=> 'Ystävälista helpottaa yhteydenpitoa henkilöihin, joiden kanssa olet usein tekemisissä. Mikäli käytössä olevassa tyylissä on tarvittava tuki. Kaikki ystävien lähettämät viestit voidaan korostaa.',
	...
	'LOGIN_EXPLAIN_UCP'			=> 'Ole hyvä ja kirjaudu sisään muokataksesi omia asetuksia',
	...
	'MESSAGE_BY_AUTHOR'				=> 'Kirjoittajan mukaan',
	...
	'MESSAGE_SENT_ON'				=> 'Lähetetty käyttäjälle',
	'MESSAGE_STORED'				=> 'Viesti on lähetetty',
	...
	'NO_EMAIL_USER'				=> 'Antamaasi sähköpostia/käyttäjätunusta ei löytynyt',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Salasanan pituus täytyy olla %1$d ja %2$d merkin väliltä ja iinä tulee olla alphanumeerisia merkkejä',
	...
	'PASSWORD_UPDATED'			=> 'salasanasi on lähetetty alkuperäiseen sähköpostiosoitteeseen.',
	...
	'PM_FROM'					=> 'Lähettäjä',
	'PM_FROM_REMOVED_AUTHOR'	=> 'Tämän viestin on lähettänyt käyttäjä, jonka tunnuksia ei enään ole.',
	'PM_ICON'					=> 'Kuvake',
	'PM_INBOX'					=> 'Saapuneet',
	...
	'TO'						=> 'Vastaanottaja',
	'TOO_MANY_RECIPIENTS'		=> 'Liian monta vastaanottajaa',
	...
	'UCP_REGISTER_DISABLE'			=> 'Uuden tunnuksen luominen ei ole tällähetkellä mahdollista.',
	'UCP_REMIND'					=> 'Lähetä salasana',
	'UCP_RESEND'					=> 'Lähetä aktivointiviesti',
	'UCP_WELCOME'					=> 'Tervetuloa omiin asetuksiin. Täällä voit tarkastella ja muokata omaa profiiliasi, asetuksiasi, seurattuja keskustelualueita ja viestiketjua. Mikäli toiminto on käytössä, voit lähettää yksityisviestejä toisille käyttäjille. Muista lukea tärkeät tiedotteet, ennen kuin jatkat eteenpäin.',
	...
	'UPLOAD_AVATAR_URL_EXPLAIN'		=> 'Anna avatar-kuvan osoite. Kuva kopioidaan tälle sivustolle.',
	...
	'WATCHED_EXPLAIN'			=> 'Alapuolella olevat alueet ja viestiketjut ovat seurannassa. Saat ilmoituksen aina uusista viesteistä. Mikäli et halua seurata jotain aluetta. Valitse se ja klikkaa <em>Lopeta seuranta</em> nappulaa.',
	...
	'GROUPS_EXPLAIN'	=> 'Käyttäjäryhmät auttavat ylläpitoa hallinnoimaan käyttäjiä helpommin. Sinut laitetaan rekisteröityessäsi johonkin ryhmään ja tämä ryhmä on oletusryhmäsi. Tämä ryhmä määrittelee näkyvyytesi toisille käyttäjille, kuten simerkiksi käyttäjätunnuksen värin, avatarin, arvon, jne... Mikäli ylläpito on sallinut, voit vaihtaa oletusryhmääsi. Sinut voidaan myös liittää toisiin ryhmiin. Jotkut käyttäjäryhmät sallivat sinun nähdä piilotettuja alueita tai antavat lisää oikeuksia tietyille alueille.',
