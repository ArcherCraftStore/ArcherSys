...
$lang = array_merge($lang, array(
	'ACP_ATTACHMENT_SETTINGS_EXPLAIN'	=> 'Qui puoi configurare le caratteristiche principali degli allegati e delle categorie speciali collegate.',
	'ACP_EXTENSION_GROUPS_EXPLAIN'		=> 'Qui puoi aggiungere, cancellare o modificare i gruppi di estensioni, puoi disabilitare tali gruppi, assegnare categorie speciali ad essi, cambiare il meccanismo di download e definire l’icona di upload che sarà visualizzata davanti all’allegato che appartiene a quel gruppo.',
	'ACP_MANAGE_EXTENSIONS_EXPLAIN'		=> 'Qui puoi gestire le estensioni permesse. Per attivare le estensioni, fai riferimento al gruppo di estensione. Consigliamo di non permettere estensioni script (come <code>php</code>, <code>php3</code>, <code>php4</code>, <code>phtml</code>, <code>pl</code>, <code>cgi</code>, <code>py</code>, <code>rb</code>, <code>asp</code>, <code>aspx</code>, ecc…).',
	'ACP_ORPHAN_ATTACHMENTS_EXPLAIN'	=> 'Qui puoi vedere gli allegati presenti nella cartella di upload che non sono stati assegnati a nessun messaggio. Questo può capitare perché alcune volte gli utenti allegano il file al messaggio senza poi inviarlo. Quindi puoi cancellare il file o allegarlo a qualche messaggio esistente. Per allegare il file ad un messaggio viene richiesto l’ID valido del messaggio che dovrai recuperare; questa caratteristica è utilizzata principalmente per quelle persone che vogliono caricare i file (spesso di grosse dimensioni) con un altro programma e assegnarlo a un messaggio esistente.',
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'		=> 'Dimensione massima di ogni file: imposta 0 se illimitata.',
	'ATTACH_MAX_PM_FILESIZE'			=> 'Dimensione massima messaggi privati',
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> 'Dimensione massima su disco concessa ad ogni utente relativamente agli allegati nei messaggi privati; imposta 0 per concedere dimensione illimitata.',
	'ATTACH_ORPHAN_URL'					=> 'Allegati orfani',
	'ATTACH_POST_ID'					=> 'ID messaggio',
	'ATTACH_QUOTA'						=> 'Quota massima allegati',
	'ATTACH_QUOTA_EXPLAIN'				=> 'Dimensione massima riservata sul disco per tutti gli allegati, imposta 0 per dimensione illimitata.',
	...
	'MAX_IMAGE_SIZE_EXPLAIN'		=> 'Dimensioni massime delle immagini allegate; impostando entrambi i valori a 0px per 0px si disabilita il controllo dimensioni.',
	...
	'NO_WRITE_UPLOAD'			=> 'Non si può scrivere nella cartella upload: modifica i permessi CHMOD in 777.',
	...
	'SECURE_ALLOW_DENY_EXPLAIN'		=> 'Modifica il comportamento predefinito quando i download sicuri sono sbilitati sulla lista Permesso/Negato a quella di <strong>whitelist</strong> (permesso) o di <strong>blacklist</strong> (negato).',
