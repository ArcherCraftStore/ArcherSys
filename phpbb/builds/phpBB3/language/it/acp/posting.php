...
$lang = array_merge($lang, array(
	'ACP_BBCODES_EXPLAIN'		=> 'Il BBCode è una speciale implementazione dell’HTML e offre un controllo maggiore su cosa e come viene mostrato nei messaggi. Da questa pagina puoi aggiungere, rimuovere e modificare BBCode.',
	...
	'BBCODE_HELPLINE_TEXT'		=> 'Aiuto in linea testo',
	...
	'BBCODE_TAG'				=> 'Tag',
	'BBCODE_TAG_TOO_LONG'		=> 'Il nome tag inseritto è troppo lungo.',
...
$lang = array_merge($lang, array(
	'ACP_ICONS_EXPLAIN'		=> 'Da questa pagina è possibile aggiungere, cancellare e modificare le icone che glu utenti possono aggiungere nei loro argomenti, o messaggi. Queste icone di solito appaiono accanto ai titoli degli argomenti all’interno del forum, o nei soggetti dei messaggi nella lista di argomenti. È anche possibile installare e creare dei pacchetti di icone.',
	'ACP_SMILIES_EXPLAIN'	=> 'Gli smilies o emoticon sono in genere piccole immagini a volte anche animate, usate per esprimere un’emozione o una sensazione. Da questa pagina è possibile aggiungere, cancellare e modificare le emoticon che l’utente potrà usare nei suoi messaggi pubblici e privati. È anche possibile installare e creare dei pacchetti di emoticon.',
	...
	'ICON_NONE_ADDED'		=> 'Nessuna icona aggiunta.',
	...
	'ICON_NONE_EDITED'		=> 'Nessuna icona modificata.',
...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'Da questo pannello è possibile aggiungere, modificare e cancellare parole che saranno automaticamente censurate nei vari forum. Tieni presente che nessuno potrà inoltre iscriversi al forum utilizzando una di queste parole come nome. Nel campo parola, sono accettate le <em>abbreviazioni</em> (*), Es. *test* vale anche per detestabile, test* va bene per testaccio, *test va bene per contest.',
...
$lang = array_merge($lang, array(
	...
	'NO_UPDATE_RANKS'		=> 'Livello cancellato. Gli utenti iscritti ed assegnati a questo livello, non sono stati aggiornati. È necessario risettare il livello per ogni iscritto.',
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Qui è possibile copntrollare i nomi utente che non sono ammessi all’utilizzo. I nomi utenti disabilitati possono essere definti tramite abbreviazione *.  È importante sapere che i nomi già registrati non possono essere specificati: per farlo occorre prima cancellare il nome Utente in questione e poi disabilitare il nome.',
...
// Reasons
$lang = array_merge($lang, array(
	'ACP_REASONS_EXPLAIN'	=> 'Qui è possibile gestire le motivazioni usate per fare rapporti o rifiutare messaggi che non si vogliono approvare. Esiste una motivazione predefinita (segnata con *) che non si può eliminare, normalmente usata per i messaggi in cui non viene specificata una diversa motivazione.',
	...
	'IS_NOT_TRANSLATED_EXPLAIN'	=> 'Motivazione <strong>non</strong> localizzata. Per avere una descrizione in lingua locale, specifica la chiave corretta nel file di lingua, sezione ragione rapporti.',
	'IS_TRANSLATED'				=> 'Motivazione localizzata.',
	'IS_TRANSLATED_EXPLAIN'		=> 'Motivazione localizzata. Se il titolo usato qui è specificato nel file di lingua, sezione ragioni del rapporto, verrà utilizzata la forma localizzata del titolo e la descrizione.',
	
	'NO_REASON'					=> 'Motivazione non esistente.',
	'NO_REASON_INFO'			=> 'Per questa motivazione occore specificare un titolo e una descrizione.',
	'NO_REMOVE_DEFAULT_REASON'	=> 'Non è possibile cancellare la motivazione predefinita "Altro".',

	'REASON_ADD'				=> 'Aggiungi motivo di rapporto/rifiuto',
	'REASON_ADDED'				=> 'Motivo di rapporto/rifiuto aggiunto.',
	...
	'REASON_EDIT'				=> 'Modifica motivo di rapporto/rifiuto',
	...
	'REASON_REMOVED'			=> 'Motivo di rapporto/rifiuto eliminato.',
	'REASON_TITLE'				=> 'Titolo motivazione',
	'REASON_TITLE_TRANSLATED'	=> 'Titolo motivazione visibile',
	'REASON_UPDATED'			=> 'Motivo di rapporto/rifiuto aggiornato.',

	'USED_IN_REPORTS'		=> 'Usato per i rapporti',
));
