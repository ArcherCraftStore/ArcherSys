...
$help = array(
   ...
   array( 
      0 => 'Perché ho ricevuto un’avvertimento?', 
      1 => 'Ciascun amministratore ha una propria serie di regole per la propria board. Se pensa che tu ne abbia infranta una, può mandarti un’avviso. Ti preghiamo di notare che questa è una decisione dell’amministratore, e il phpBB Group non ha niente a che fare con questi avvisi.' 
   ), 
   array( 
      0 => 'Come posso segnalare messaggi ai moderatori?', 
      1 => 'Se l’amministratore l’ha permesso, vai al messaggio che vuoi segnalare: dovresti vedere un pulsante che serve per fare rapporto dei messaggi. Cliccandolo sarai introdotto alla procedura necessaria per la segnalazione dei messaggi.' 
   ), 
   array( 
   ...
   array( 
      ...
      1 => 'Per sottoscriverti ad un forum, quando entri nel forum premi il collegamento "Sottoscrivi forum": con questo sottosrivi un forum esattamente come faresti con un argomento. Per sottoscrivere un argomento, puoi sia inserirvi un messaggio e selezionare la casella relativa o premere – all’interno dell’argomento stesso – il collegamento che dice "Sottoscrivi argomento".' 
   ), 
   array( 
   ...
   array( 
      ...
      1 => 'Questo programma (nella sua forma originale) è prodotto e rilasciato da <a href="http://www.phpbb.com/" target="_blank">phpBB Group</a>, che ne detiene anche il brevetto. È reso disponibile sotto la GNU General Public Licence e può essere liberamente distribuito; clicca sul collegamento per maggiori informazioni.' 
   ), 
   array( 
