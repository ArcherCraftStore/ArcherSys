...
$lang = array_merge($lang, array(
	...
	'CONV_ERROR_ATTACH_FTP_DIR'			=> 'L’invio FTP degli allegati sulla vecchia board è abilitato. Disabilita l’opzione ed assicurati di specificare una cartella upload valida, infine copia tutti i file allegati a questa catella (che deve essere accessibile da web). Fatto questo fai ripartire il convertitore.',
	...
	'CONV_ERROR_REPLACE_FORUM'			=> 'Impossibile Impossibile inserire nuova sezione in sostituzione della vecchia.',
	...
	'COULD_NOT_FIND_PATH'		=> 'Non trovo il percorso precedente della tua board. Controlla le tue impostazioni e prova di nuovo.<br />» Il percorso sorgente specificato era %s.',
	...
	'FILES_OPTIONAL_EXPLAIN'	=> '<strong>Facoltativi</strong> - Questi file, cartelle o impostazioni permessi non sono richiesti. Il sistema di installazione tenterà di utilizzare diverse tecniche per crearli, se non esistono o non possono essere scritti. Tuttavia, la loro presenza accelererà installazione.',
	'FILES_REQUIRED'			=> 'File e Cartelle',
	'FILES_REQUIRED_EXPLAIN'	=> '<strong>Richiesti</strong> - Per funzionare correttamente phpBB ha bisogno di essere in grado di accedere o di scrivere certi file o cartelle. Se vedi “Non trovato” devi creare il file o la cartelle relative. se vedi “Non scrivibile” devi cambiare i permessi sul file o cartelle per permettere a phpBB di scriverlo.',
	'FILLING_TABLE'				=> 'La tabella <strong>%s</strong> viene popolata',
	'FILLING_TABLES'			=> 'Tabelle in popolamento',
	'FINAL_STEP'				=> 'Sto processando il passaggio finale',
	...
	'FORUM_PATH'				=> 'Persorso della board',
	'FORUM_PATH_EXPLAIN'		=> 'Questo è il percorso <strong>relativo</strong> su disco della tua precedente board alla <strong>radice del tuo phpBB installation</strong>.',
	'FOUND'						=> 'Trovato',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		<p>Hai appena installato correttamente phpBB %1$s. Da qui, puoi scegliere tra due opzioni per decidere cosa fare con il tuo phpBB3 appena installato:</p>
...
// TODO: write some more introductions here
	...
	'INST_ERR_DB_NO_FIREBIRD'	=> 'La versione di Firebird installata su questa macchina è più vecchia della 2.0 e devi aggiornare a una versione più recente.',
...
// TODO: Write some explanatory introduction text
	...
	'OVERVIEW_BODY'					=> 'Benvenuto nella nuova generazione di phpBB, dopo 2.0.x, phpBB 3.0! Questo rilascio è inteso affinchè l’uso ci aiuti ad identificare eventuali bugs o problemi di altra natura.</p><p>Leggi la <a href="../docs/INSTALL.html">guida all’installazione</a> per maggiori informazioni sull’installazione di phpBB3.</p><p><strong style="text-transform: uppercase;">NB:</strong> Questo rilascio è <strong style="text-transform: uppercase;">ancora non definitivo</strong>. Attendere il rilascio finale completo prima di utilizzarlo online.</p><p>Questo sistema d’installazione ti guiderà al processo d’installazione di phpBB, convertendo un sistema di programma differente o aggiornando l’ultima versione di phpBB. Per maggiori informazioni su ogni opzione, selezionala dal menu qui sopra.',
	...
	'PRE_CONVERT_COMPLETE'			=> 'Tutti i passaggi di pre-conversione sono stati completati correttamente. Ora puoi iniziare il processo di conversione effettivo. Nota che è possibile che tu debba adattare manualmente numerose cose. Dopo la conversione, controlla in special modo i permessi assegnati, ricostruire il vostro indice di ricerca se necessario e assicurarti anche che i file siano stati copiati correttamente, ad esempio gli avatar e le emoticon.',
	'PROCESS_LAST'					=> 'Elaborazione delle ultime istruzioni',

	'REFRESH_PAGE'				=> 'Aggiorna pagina per continuare conversione',
	'REFRESH_PAGE_EXPLAIN'		=> 'Se impostato su SI, il convertiore aggiornerà la pagina per continuare la conversione dopo aver terminato un passaggio. Se questa è la tua prima conversione per scopi di verifica e per determinare qualsiasi errore in anticipo, ti suggeriamo di impostarlo su NO.',
//	'REQUIRED'					=> 'Required',
	'REQUIREMENTS_TITLE'		=> 'Compatibilità installazione',
	'REQUIREMENTS_EXPLAIN'		=> 'Prima di procedere all’installazione completa phpBB eseguirà alcuni test sulla configurazione del tuo server e dei tuoi tuoi file, per assicurarsi che tu possa installare ed eseguire phpBB. Assicurati di leggere accuratamente i risultati e non procedere fin quando tutti i test richiesti non saranno superati. Se desideri utilizzare una qualunque delle caratteristiche a seconda dei test opzionali, devi essere sicuro che anche tutti i test siano stati superati.',
	...
	'STAGE_CREATE_TABLE_EXPLAIN'	=> 'Le tabelle presenti nel database utilizzate da phpBB 3.0 sono state create e popolate con qualche dato iniziale. Procedi alla schermata successiva per completare l’installazione di phpBB.',
...
// TODO: Write some text on obtaining support
	'SUPPORT_BODY'				=> 'Durante la fase RC sarà fornito pieno supporto su <a href="http://www.phpbb.com/community/viewforum.php?f=46">phpBB 3.0.x support forums</a>. Provvederemo a rispondere a domande generali su setup, problemi di configurazione, problemi di conversione e supporto per problemi dovuti il più delle volte a bug. Permettiamo anche discussioni su modifiche e aggiunte di codici o stili personalizzati.</p><p>Per ulteriore assistenza consulta la nostra <a href="http://www.phpbb.com/support/documentation/3.0/quickstart/">Guida rapida di installazione</a> e <a href="http://www.phpbb.com/support/documentation/3.0/">la documentazione online</a>.</p><p>Per essere sicuro di essere aggiornato alle ultime notizie e rilasci, <a href="http://www.phpbb.com/support/">iscriviti alla nostra mailing list</a>',
	'SYNC_FORUMS'				=> 'Inzio sincronizzazione delle sezioni',
	...
	'SYNC_TOPICS'				=> 'Inzio sincronizzazione degli argomenti',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Tutti i file sono aggiornati all’ultima versione di phpBB. Adesso devi <a href="../ucp.php?mode=login">effettuare il login</a> e controllare se tutto funziona correttamente. Non dimenticare di cancellare, rinominare oppure spostare la cartella "install"!',
	'ARCHIVE_FILE'				=> 'File sorgente all’interno di archivio',

	'BACK'				=> 'Indietro',
	'BINARY_FILE'		=> 'File binario',
	'BOT'				=> 'Spider/Robot',

	'CHANGE_CLEAN_NAMES'			=> 'Il metodo utilizzato per controllare se un nome utente non sia usato da più utenti è cambiato. Con questo nuovo metodo di comparazione potrebbe risultare che utenti abbiano un nome utente uguale. Devi eliminare o rinominare questi utenti per fare in modo che ogni nome utente sia usato da solamente un utente, prima che tu possa continuare.',
	...
	'COLLECTED_INFORMATION'			=> 'Informazioni sui file raccolti',
	...
	'CONTINUE_UPDATE_NOW'			=> 'Continua adesso il processo di aggiornamento',
	'CURRENT_FILE'					=> 'File originale attuale',
	...
	'DIFF_SEP_EXPLAIN'					=> 'Fine del file corrente / Inizio del nuovo file aggiornato',
	...
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> 'Una volta scaricato devi decomprimere l’archivio. All’interno troverai i file modificati che devi caricare nella tua cartella phpBB, mantenendone la . Dopo che hai caricato tutti i file controllali di nuovo con l’altro bottone qui sotto.',
	...
	'FILES_NEW_EXPLAIN'				=> 'I seguenti file attualmente non esistono all’interno della vostra installazione.',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'	=> 'I seguenti file non sono stati modificati e rappresentano i file originali di phpBB della versione da cui stai aggiornando.',
	...
	'MERGE_MOD_FILE_OPTION'		=> 'Unisci le differenze ed usa il nuovo codice all’interno del blocco in conflitto',
	'MERGE_NEW_FILE_OPTION'		=> 'Unisci le differenze ed usa il nuovo codice all’interno del blocco in conflitto',
	'MERGE_SELECT_ERROR'		=> 'Il metodo per unire i file conflittuali non è stato correttamente selezionato.',

	'NEW_FILE'						=> 'Nuovi file aggiornati',
	...
	'SOME_QUERIES_FAILED'		=> 'Alcune querie sono venute a mancare. Le istruzioni e gli errori sono elencati qui sotto.',
	'SQL'						=> 'SQL',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			...
			<li>Invia le parti decompresse complete della cartella install alla root del tuo phpBB (ovvero dove si trova il file config.php).<br /><br /></li>
		</ul>
	...
	'UPDATE_DB_SUCCESS'				=> 'Aggiornamento database riuscita.',
	'USER_ACTIVE'					=> 'Utente attivo',
	'USER_INACTIVE'					=> 'Utente non attivo',

	'VERSION_CHECK'				=> 'Controllo versione',
	'VERSION_CHECK_EXPLAIN'		=> 'Controlla per vedere se la versione di phpBB che attualmente attiva è aggiornata .',
	'VERSION_NOT_UP_TO_DATE'	=> 'La presente versione di phpBB non è aggiornata. Procedi con il processo di aggiornamento .',
	'VERSION_NOT_UP_TO_DATE_ACP'=> 'La presente versione di phpBB non è aggiornata.<br />Qui sotto troverai un collegamento all’annuncio del rilascio dell’ultima versione, completo di istruzioni su come effettuare l’aggiornamento.',
	'VERSION_UP_TO_DATE'		=> 'L’installazione è aggiornata, non sono presenti aggiornamenti per la vostra versione di phpBB. Se desideri comunque puoi continuare a fare il controllo di validità dei file.',
	'VERSION_UP_TO_DATE_ACP'	=> 'L’installazione è aggiornata, non sono presenti aggiornamenti per la vostra versione di phpBB. Non dovete aggiornare la presente installazione.',
...
$lang = array_merge($lang, array(
	...
	'CONFIG_SITE_DESC'				=> '_Breve_ testo di descrizione del forum',
	'CONFIG_SITENAME'				=> 'tuodominio.it',

	'DEFAULT_INSTALL_POST'			=> 'Questo è un esempio di messaggio del tuo phpBB3. Puoi cancellare questo messaggio, argomento e forum. Potrai quindi utilizzare il tuo phpBB3 per creare la tua nuova comunità.!',
	...
	'FORUMS_FIRST_CATEGORY'			=> 'La mia prima Categoria',
	'FORUMS_TEST_FORUM_DESC'		=> 'Questo è un forum di prova.',
