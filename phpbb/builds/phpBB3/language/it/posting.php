...
* @ translation by phpbb.it last revised 2007/08/20 01:23:00
*/
...
$lang = array_merge($lang, array(
	...
	'ADD_ATTACHMENT_EXPLAIN'	=> 'Se desideri allegare uno o più file inserisci i dettagli seguenti.',
	...
	'BBCODE_F_HELP'				=> 'Dimensione testo: [size=x-small]testo piccolo[/size]',
	...
	'MORE_SMILIES'				=> 'Visualizza altri smilies',
	...
	'PHP_SIZE_OVERRUN'			=> 'La dimensione del file allegato è eccessiva, il limite massimo è %d MB.<br />Il limite è definito in php.ini e non può essere ignorato da phpBB.',
	'PLACE_INLINE'				=> 'Inserisci in linea con il testo',
	'POLL_DELETE'				=> 'Elimina sondaggio',
	'POLL_FOR'					=> 'Continua sondaggio per',
	'POLL_FOR_EXPLAIN'			=> 'Scrivi 0 o lascia il campo vuoto per un sondaggio infinito.',
	'POLL_MAX_OPTIONS'			=> 'Opzioni per utente',
	'POLL_MAX_OPTIONS_EXPLAIN'	=> 'Numero massimo di voci che un utente può selezionare al momento del voto.',
	'POLL_OPTIONS'				=> 'Opzioni sondaggio',
	'POLL_OPTIONS_EXPLAIN'		=> 'Inserisci una voce per riga. Puoi inserire fino a <strong>%d</strong> opzioni.',
	'POLL_OPTIONS_EDIT_EXPLAIN'	=> 'Inserisci una voce per riga. Puoi inserire fino a <strong>%d</strong> opzioni. Se rimuovi o aggiungi opzioni tutti i voti precedenti saranno ripristinati.',
	'POLL_QUESTION'				=> 'Domanda del sondaggio',
	'POLL_TITLE_TOO_LONG'		=> 'Il titolo del sondaggio deve contenere meno di 100 caratteri.',
	'POLL_TITLE_COMP_TOO_LONG'	=> 'Il titolo di sondaggio è troppo grande, valuta di rimuovere BBCode o gli smilies.',
	...
	'STICK_TOPIC_FOR'			=> 'Marca come Importante per',
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Scrivi 0 o lascia il campo vuoto per durata infinita di Importante/Annuncio.',
	...
	'TOO_MANY_CHARS_POST'		=> 'Il messaggio contiene %1$d caratteri. Il numero massimo di caratteri permessi sono %2$d.',
	'TOO_MANY_CHARS_SIG'		=> 'La tua firma contiene %1$d caratteri. Il numero massimo di caratteri permessi son %2$d.',
	'TOO_MANY_POLL_OPTIONS'		=> 'Hai cercato di inserire troppe voci al sondaggio.',
	'TOO_MANY_SMILIES'			=> 'Il messaggio contiene troppe emoticons. Il limite massimo è %d.',
	...
	'URL_IS_OFF'				=> '[url] <em>NON ATTIVE</em>',
