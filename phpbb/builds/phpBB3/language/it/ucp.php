...
* @ translation by phpbb.it last revised 2007/07/09 01:23:00
*/
...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Accendendo a “%1$s” (in seguito “noi”, “nostro„,  “%1$s”, “%2$s”), l’utente accetta di essere vincolato legalmente alle seguenti condizioni d’uso. Se non accetti di essere limitato legalmente alle condizioni d’uso seguenti non utilizzare i servizi offerti da “%1$s”. Le condizioni d’uso possono cambiare in qualunque momento, sarà nostra premura avvisarti di tali modifiche, benchè sia opportuno controllare con frequenza queste pagine per eventuali modifiche, dato che l’uso continuato dei servizi di “%1$s” implica la completa accettazione delle condizioni d’uso.<br />
	<br />
	...
	<br />
	La password viene criptata (hash unidirezionale) per motivi di sicurezza. In ogni caso ti raccomandiamo di non utilizzare la stessa password in troppi siti. La tua password è il metodo di accesso al tuo account a “%1$s”, quindi proteggila attentamente. Ricorda che in nessuna circostanza affiliati di “%1$s”, phpBB o terzi possono legittimamente richiedere la tua password. Nel caso dimenticassi la tua password, puoi utilizzare l’opzione “Ho dimenticato la mia password” prevista nel software phpBB. Durante questo procedimento ti verrà richiesto il tuo nome utente ed indirizzo e-mail, in modo che il software phpBB possa generare una nuova password che ti permetterà di accedere nuovamente al tuo account.<br />',
));
...
$lang = array_merge($lang, array(
	...
	'ADD_TO'						=> 'Aggiungi [A]',
	'ADMIN_EMAIL'					=> 'Gli amministratori possono inviarmi e-mail',
	'AGREE'							=> 'Accetto queste condizioni d’uso',
	'ALLOW_PM'						=> 'Permetti agli utenti di invarti messaggi privati',
	...
	'ATTACHMENTS_EXPLAIN'			=> 'Questa è una lista di allegati che hai aggiunto ai messaggi in questa sistema.',
	...
	'AVATAR_EXPLAIN'				=> 'Dimensioni massime: larghezza: %1$d pixel, altezza: %2$d pixel, grandezza file: %3$dkB.',
	...
	'CLICK_RETURN_FOLDER'		=> '%1$sRitorna al tuo “%3$s” cartella%2$s',
	...
	'CONFIRM_EXPLAIN'			=> 'Per impedire registazioni automatiche il sistema richiede l’inserimento di un codice di conferma. Il codice è visualizzato nell’immagine che dovresti vedere quì sotto. Se per qualsiasi motivo non riuscissi a leggere il codice contatta un %samministratore%s.',
	...
	'DEFAULT_ACTION_EXPLAIN'	=> 'Questa azione verà eseguita in caso nessuna delle precedenti è applicabile.',
	...
	'DEFAULT_SMILIES'			=> 'Visualizza sempre gli smilies',
	...
	'DRAFTS_EXPLAIN'			=> 'Qui puoi leggere, modificare e cancellare le tue bozze salvate.',
	...
	'EXPORT_FOLDER'				=> 'Metodo di esportazione',
	...
	'FIELD_INVALID_CHARS_NUMBERS_ONLY'	=> 'Il campo “%s” ha caratteri non validi, sono ammessi solo numeri.',
	'FIELD_INVALID_CHARS_ALPHA_ONLY'	=> 'Il campo “%s” ha caratteri non validi, sono ammessi solo caratteri alfanumerici.',
	'FIELD_INVALID_CHARS_SPACERS_ONLY'	=> 'Il campo “%s” ha caratteri non validi, sono ammessi solo caratteri alfanumerici, spazio o -+_[].',
	'FIELD_INVALID_DATE'				=> 'Il campo “%s” riporta una data non valida.',

	'FOE_MESSAGE'				=> 'Messaggio da ignorato',
	'FOES_EXPLAIN'				=> 'Gli ignorati sono utenti che non vengono più presi in considerazione. I messaggi di questi utenti non saranno completamente visibili. I messaggi privati sono comunque permessi. Tieni presente che non puoi ignorare moderatori o amministratori.',
	...
	'FRIENDS'					=> 'Amici',
	'FRIENDS_EXPLAIN'			=> 'Gli amici ti permettono un accesso veloce agli utenti con cui comunichi frequentemente. Se il template è predisposto, ogni messaggio fatto da un amico sarà evidenziato.',
	...
	'HIDE_ONLINE'				=> 'Nascondi il mio stato quando sono connesso',
	...
	'ITEMS_REQUIRED'			=> 'Le voci contrassegnate con * sono campi obbligatori del profilo e devono essere compilati.',
	...
	'MESSAGE_REMOVED_FROM_OUTBOX'	=> 'Il messaggio è stato rimosso dall’autore prima che venisse racapitato.',
	'MESSAGE_SENT_ON'				=> 'il',
	...
	'NOTIFY_ON_PM'					=> 'Avvisami quando ricevo messaggi privati',
	...
	'POPUP_ON_PM'				=> 'Finestra pop up per nuovo messaggio privato',
	...
	'RESIGN_SELECTED'					=> 'Annulla selezionato',
	'RETURN_FOLDER'						=> '%1$sRitorna alla cartella precendete%2$s',
	...
	'SENT_AT'					=> 'Inviato il',
	'SHOW_EMAIL'				=> 'Gli utenti possono contattarmi via e-mail',
	...
	'TOO_MANY_REGISTERS'		=> 'Hai superato il numero massimo di tentativi di registrazione per questa sessione. Riprovara più tardi.',
	...
	'UCP_MAIN'					=> 'Panoramica',
	'UCP_MAIN_ATTACHMENTS'		=> 'Gestisci allegati',
	'UCP_MAIN_BOOKMARKS'		=> 'Gestisci segnalibri',
	'UCP_MAIN_DRAFTS'			=> 'Gestisci bozze',
	'UCP_MAIN_FRONT'			=> 'Prima pagina',
	'UCP_MAIN_SUBSCRIBED'		=> 'Gestisci sottoscrizioni',

	'UCP_MSNM'					=> 'MSN Messenger',
	'UCP_NO_ATTACHMENTS'		=> 'Non hai allegati.',

	'UCP_PREFS'					=> 'Preferenze sistema',
	'UCP_PREFS_PERSONAL'		=> 'Modifica preferenze globali',
	'UCP_PREFS_POST'			=> 'Modifica preferenze messaggi',
	'UCP_PREFS_VIEW'			=> 'Modifica opzioni di visualizzazione',
	
	'UCP_PM'					=> 'Messaggi privati',
	'UCP_PM_COMPOSE'			=> 'Componi messaggio',
	'UCP_PM_DRAFTS'				=> 'Gestisci bozze MP',
	...
	'UCP_PROFILE_REG_DETAILS'	=> 'Modifica preferenze account',
	'UCP_PROFILE_SIGNATURE'		=> 'Modifica firma',

	'UCP_USERGROUPS'			=> 'Gruppi utenti',
	'UCP_USERGROUPS_MEMBER'		=> 'Modifica iscrizioni',
	'UCP_USERGROUPS_MANAGE'		=> 'Gestisci gruppi',
	...
	'UCP_WELCOME'					=> 'Benvenuto nel Pannello di Controllo Utente. Da qui puoi monitorare, vedere o aggiornare il tuo profilo, le preferenze, la sottoscrizione a forum e argomenti. Puoi anche inviare messaggi ad altri utenti (se consentito). Assicurati di aver letto gli annunci prima di continuare.',
	...
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'La lunghezza deve avere minimo %1$d e massimo %2$d caratteri.',
	...
	'VIEW_SMILIES'				=> 'Visualizza smilies come immagini',
	...
	'WATCHED_EXPLAIN'			=> 'Questa è la lista di forum ed argomenti ai quali sei iscritto. Sarai avvisato di nuovi messaggi in entrambi. Per rimuove l’iscrizione, seleziona il forum o l’argomento e clicca <em>Smetti di controllare selezionati</em>.',
	...
	'YOUR_WARNINGS'				=> 'Il tuo livello di avvisi',
