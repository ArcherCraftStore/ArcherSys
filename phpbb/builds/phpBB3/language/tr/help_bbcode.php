...
$help = array(
	...
	array(
		0 => '--',
		1 => 'Link (bağlantı) oluşturma'
	),
	array(
		0 => 'Ayrı bir siteye link verme',
		1 => 'phpBB, BBCode yoluyla daha iyi bir şekilde URLler olarak bilinen URIler (Uniform Resource Indicators) oluşturmayı destekler.<ul><li>Birinci yöntem <strong>[url=][/url]</strong> etiketiyledir. = işaretinin arkasına yazılanlar link olarak çalışır. Örneğin phpBB.com\'a link vermek için şu şekilde yazın:<br /><br /><strong>[url=http://www.phpbb.com/]</strong>phpBB\'yi ziyaret edin!<strong>[/url]</strong><br /><br />Sonuçta şu linki göreceksiniz: <a href="http://www.phpbb.com/">phpBB\'yi ziyaret edin!</a> Not: Bu link kullanıcıların tarayıcı ayarlarına bağlı olarak aynı pencerede veya yeni bir pencerede açılır.</li><li>Link adresinin gösterilmesini istiyorsanız, şu şekildede yazabilirsiniz:<br /><br /><strong>[url]</strong>http://www.phpbb.com/<strong>[/url]</strong><br /><br />Sonuçta şu linki göreceksiniz: <a href="http://www.phpbb.com/">http://www.phpbb.com/</a></li><li>phpBB ayrıca <i>Sihirli Linkler</i> denen bir işleme sahip. Bunun sayesinde, kurallara uygun bir şekilde yazılan her link adresi otomatik olarak link\'e çevrilir, herhangi bir etiket, hatta http:// yazmanıza gerek kalmaz. Örn. www.phpbb.com yazınca, izlenim sayfasında otomatik olarak <a href="http://www.phpbb.com/">www.phpbb.com</a> olarak görüntülenir.</li><li>Aynı işlem email adresleri için uygulanır. Dilerseniz özel olarak bir adres belirleyebilirsiniz, örn.:<br /><br /><strong>[email]</strong>no.one@domain.adr<strong>[/email]</strong><br /><br />yazılınca şu şekilde görüntülenir: <a href="mailto:no.one@domain.adr">no.one@domain.adr</a> Veya basitçe no.one@domain.adr yazabilirsiniz ve mesajınız görüntülendiğinde bu kısım otomatik olarak link\'e çevrilir.</li></ul>Bütün BBCode etiketleri gibi, link adreslerinide diğer etiketlerin içine alabilirsiniz, örn. <strong>[img][/img]</strong> (bir sonraki madde bakın), <strong>[b][/b]</strong>, vs. Biçimleme etiketlerinde olduğu gibi, etiketlerin düzgün bir şekilde sırasıyla kapatılmasını kendiniz sağlamalısınız, örn.:<br /><br /><strong>[url=http://www.google.com/][img]</strong>http://www.google.com/intl/en_ALL/images/logo.gif<strong>[/url][/img]</strong><br /><br />doğru <span style="text-decoration: underline">değildir</span> ve hatta mesajınızın silinmesine yol açabilir, bu konuda dikkatli olmanız gerek.'
	),
	array(
		0 => '--',
  ...
  array( 
    ...
    1 => 'Eklentiler, yeni <strong>[attachment=][/attachment]</strong> BBCode etiketlerini kullanarak bir mesajın herhangi bir bölümüne yerleştirilebilir, tabi ki eğer eklenti özelliği site yöneticisi tarafından açıldıysa ve eklentiler oluşturmak için uygun izinleriniz verildiyse... Satıriçi eklentiler yerleştirmek için mesaj gönderme ekranında bir seçenek kutusu (bir buton sırasıyla) bulunur.' 
	),
	array(
		0 => '--',
		1 => 'Diğer Konular'
	...
	array(
		...
		1 => 'Eğer siz bu sitede bir yöneticiyseniz ve uygun izinleriniz varsa, Özel BBCode\'lar bölümü aracılığıyla daha fazla BBCode ekleyebilirsiniz.'
	)
);
