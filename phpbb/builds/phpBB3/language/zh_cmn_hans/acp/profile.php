...
$lang = array_merge($lang, array(
	...
	'CUSTOM_FIELDS_NOT_TRANSLATED'	=> '有一个或多个栏目没有对应的翻译. 请输入对应的翻译并点击 &quot;翻译&quot; 链接.',
	...
	'DISPLAY_AT_REGISTER_EXPLAIN'	=> '启用这个选项后, 用户注册时会显示此栏目并且可以在用户控制面板中更改.',
	'DISPLAY_PROFILE_FIELD'			=> '用户资料中显示',
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> '只有管理员和版主可以查看/填写这个栏目. 如果启用这个选项, 这个栏目只显示在用户的个人资料查看中.',
	...
	'REQUIRED_FIELD'			=> '必填栏目',
	'REQUIRED_FIELD_EXPLAIN'	=> '强制用户填写的栏目. 这将在注册过程和用户控制面板中显示这个栏目.',
	'ROWS'						=> '行',
