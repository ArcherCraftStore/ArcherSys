...
$lang = array_merge($lang, array(
	...
	'COMMON_WORD_THRESHOLD_EXPLAIN'			=> '在所有的帖子中都频繁出现的单词将被识别为高频词. 高频词在搜索中将被忽略. 设置0则取消这项功能. 只有当帖子数大于100时这个设置才能生效.',
	...
	'MIN_SEARCH_AUTHOR_CHARS_EXPLAIN'		=> '用户在搜索作者姓名时必须输入的字符串长度. 如果作者用户名长度小于这个数字, 您一人可以输入完整用户名搜索用户的帖子.',
